...
const STATUS_COLOR = { "operativo": "#22c55e", "in manutenzione": "#f59e0b", "fuori servizio": "#ef4444", "da accettare": "#818cf8", "aperto": "#2F9E8E", "in corso": "#f59e0b", "in attesa ricambi": "#f59e0b", "in attesa cliente": "#a855f7", "in attesa accesso": "#38bdf8", "chiuso": "#22c55e", "in attesa": "var(--text-2)", "confermato": "#2F9E8E", "spedito": "#a855f7", "ricevuto": "#22c55e", "annullato": "#ef4444", "emessa": "#2F9E8E", "pagata": "#22c55e", "scaduta": "#ef4444", "bozza": "var(--text-2)" };
...
var tk = document.createElement("style"); tk.textContent = ":root{--bg:#0D0D12;--bg-deep:#0a0a0f;--bg-2:#0F0F14;--surface:#141418;--card:#16161C;--surface-2:#1E1E28;--surface-3:#202028;--surface-4:#32323F;--border:#2a3040;--border-2:#1e2a3a;--border-3:#2a3344;--border-4:#2A2A38;--text:#e2e8f0;--text-strong:#cbd5e1;--text-2:#94a3b8;--text-3:#64748b;--text-4:#475569;--ok-bg:#16361f;--warn-bg:#1c1607;--err-bg:#1a0d0d;--info-bg:#11161f;}[data-theme='light']{--bg:#eef1f6;--bg-deep:#e3e8ef;--bg-2:#e8edf3;--surface:#ffffff;--card:#ffffff;--surface-2:#eef2f7;--surface-3:#e3e9f1;--surface-4:#d6dde7;--border:#cdd6e1;--border-2:#dde3ec;--border-3:#d3dbe6;--border-4:#cdd6e1;--text:#14202e;--text-strong:#0b1320;--text-2:#445268;--text-3:#586579;--text-4:#737f92;--ok-bg:#e7f6ee;--warn-bg:#fbf2dd;--err-bg:#fdeaea;--info-bg:#eaf1fb;}html,body{background:var(--bg);color:var(--text);} body{transition:background-color .2s ease;}"; document.head.appendChild(tk);
...
React.createElement("div", { style: { fontSize: 13, color: "#fca5a5", maxWidth: 540, wordBreak: "break-word", fontFamily: "monospace", background: "var(--err-bg)", border: "1px solid #f8717155", borderRadius: 8, padding: "10px 12px" } }, msg),
...
React.createElement("button", { onClick: () => this.setState({ err: null }), style: { background: "#2F9E8E", color: "#06251f", border: "none", borderRadius: 8, padding: "10px 20px", fontWeight: 800, cursor: "pointer" } }, "Chiudi e riprova"),
...
const DEMO_SEED = {"company": {"name": "MedTrace Demo S.r.l.", "subtitle": "Assistenza apparecchiature biomedicali — versione dimostrativa", "address": "Via Esempio 10, 34100 Trieste (TS)", "vat": "00000000000", "iban": "", "invoicePrefix": "DEMO", "phone": "040 0000000", "email": "info@medtrace-demo.example", "logo": "", "rolePermissions": {"superuser": ["dashboard", "jobs", "iec", "func", "agenda", "assets", "instruments", "customers", "parts", "invoices", "procedures", "help"], "admin": ["jobs", "iec", "func", "agenda", "assets", "instruments", "customers", "parts", "invoices", "procedures", "help", "dashboard", "scadenze"], "finance": ["dashboard", "jobs", "assets", "customers", "invoices", "procedures", "help", "parts"], "tecnico": ["dashboard", "jobs", "iec", "func", "assets", "instruments", "parts", "procedures", "help"]}, "stickerPrompt": true, "logoHasName": false, "technicians": [{"name": "Mario Rossi"}, {"name": "Laura Bianchi"}]}, "customers": [{"id": "c_demo_1", "name": "Ospedale Riuniti Demo", "vat": "01234567890", "fiscalCode": "", "address": "Via della Salute 1, 34100 Trieste", "contact": "Dott. Marco Verdi", "email": "ufficio.tecnico@ospedaledemo.example", "phone": "040 1234567", "notes": "Cliente di esempio", "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null}, {"id": "c_demo_2", "name": "Casa di Cura Esempio S.p.A.", "vat": "09876543210", "fiscalCode": "", "address": "Largo Ippocrate 5, 34170 Gorizia", "contact": "Ing. Sara Neri", "email": "manutenzione@casacuraesempio.example", "phone": "0481 765432", "notes": "Cliente di esempio", "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null}, {"id": "c_demo_3", "name": "Poliambulatorio Salute Demo", "vat": "05551112220", "fiscalCode": "", "address": "Corso Italia 88, 33100 Udine", "contact": "Dott.ssa Elena Bruno", "email": "info@poliambulatoriodemo.example", "phone": "0432 998877", "notes": "Cliente di esempio", "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null}], "assets": [{"id": "a_demo_01", "name": "Defibrillatore manuale", "brand": "Philips", "model": "HeartStart MRx", "serial": "DEMO-SN-001", "location": "Cardiologia — Sala 1", "customerId": "c_demo_1", "status": "operativo", "lastService": "2025-05-21", "nextService": "2026-05-21", "serviceInterval": 12, "riskClass": "IIb", "iecNorm": "62353", "iecClass": "I", "patientType": "CF", "notes": "Apparecchio di esempio", "photos": [], "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "intervalIec": 12, "intervalFunc": 12, "deleted": false, "deletedAt": null, "assetCode": "AST-001", "manufactureDate": "2021-03-01", "commissionDate": "2021-06-15", "purchaseCost": null, "supplier": "Fornitore Demo S.r.l.", "replacementDate": null, "batteryDate": null, "batteryChanged": false, "lastSeenAt": null, "epc": "E28011700000000000000001", "lastLocation": "Cardiologia — Sala 1", "lastLocationDate": "2026-06-13T09:30:00.000Z"}, {"id": "a_demo_02", "name": "Ventilatore polmonare", "brand": "Dräger", "model": "Evita V300", "serial": "DEMO-SN-002", "location": "Terapia Intensiva", "customerId": "c_demo_1", "status": "in manutenzione", "lastService": "2025-06-05", "nextService": "2026-06-05", "serviceInterval": 12, "riskClass": "IIb", "iecNorm": "62353", "iecClass": "I", "patientType": "BF", "notes": "Apparecchio di esempio", "photos": [], "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "intervalIec": 12, "intervalFunc": 12, "deleted": false, "deletedAt": null, "assetCode": "AST-002", "manufactureDate": "2021-03-01", "commissionDate": "2021-06-15", "purchaseCost": null, "supplier": "Fornitore Demo S.r.l.", "replacementDate": null, "batteryDate": null, "batteryChanged": false, "lastSeenAt": null, "epc": "E28011700000000000000002", "lastLocation": "Terapia Intensiva", "lastLocationDate": "2026-06-14T09:30:00.000Z"}, {"id": "a_demo_03", "name": "Elettrobisturi", "brand": "Erbe", "model": "VIO 300 D", "serial": "DEMO-SN-003", "location": "Blocco Operatorio 2", "customerId": "c_demo_1", "status": "operativo", "lastService": "2025-06-20", "nextService": "2026-06-20", "serviceInterval": 12, "riskClass": "IIb", "iecNorm": "62353", "iecClass": "I", "patientType": "CF", "notes": "Apparecchio di esempio", "photos": [], "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "intervalIec": 12, "intervalFunc": 12, "deleted": false, "deletedAt": null, "assetCode": "AST-003", "manufactureDate": "2021-03-01", "commissionDate": "2021-06-15", "purchaseCost": null, "supplier": "Fornitore Demo S.r.l.", "replacementDate": null, "batteryDate": null, "batteryChanged": false, "lastSeenAt": null, "epc": "E28011700000000000000003", "lastLocation": "", "lastLocationDate": ""}, {"id": "a_demo_04", "name": "Monitor multiparametrico", "brand": "GE", "model": "CARESCAPE B650", "serial": "DEMO-SN-004", "location": "Pronto Soccorso", "customerId": "c_demo_2", "status": "operativo", "lastService": "2025-06-27", "nextService": "2026-06-27", "serviceInterval": 12, "riskClass": "IIb", "iecNorm": "62353", "iecClass": "I", "patientType": "CF", "notes": "Apparecchio di esempio", "photos": [], "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "intervalIec": 12, "intervalFunc": 12, "deleted": false, "deletedAt": null, "assetCode": "AST-004", "manufactureDate": "2021-03-01", "commissionDate": "2021-06-15", "purchaseCost": null, "supplier": "Fornitore Demo S.r.l.", "replacementDate": null, "batteryDate": null, "batteryChanged": false, "lastSeenAt": null, "epc": "E28011700000000000000004", "lastLocation": "Pronto Soccorso", "lastLocationDate": "2026-06-10T09:30:00.000Z"}, {"id": "a_demo_05", "name": "Pompa infusionale", "brand": "B.Braun", "model": "Infusomat Space", "serial": "DEMO-SN-005", "location": "Reparto Degenze 3A", "customerId": "c_demo_2", "status": "operativo", "lastService": "2025-07-10", "nextService": "2026-07-10", "serviceInterval": 12, "riskClass": "IIb", "iecNorm": "62353", "iecClass": "I", "patientType": "CF", "notes": "Apparecchio di esempio", "photos": [], "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "intervalIec": 12, "intervalFunc": 12, "deleted": false, "deletedAt": null, "assetCode": "AST-005", "manufactureDate": "2021-03-01", "commissionDate": "2021-06-15", "purchaseCost": null, "supplier": "Fornitore Demo S.r.l.", "replacementDate": null, "batteryDate": null, "batteryChanged": false, "lastSeenAt": null, "epc": "E28011700000000000000005", "lastLocation": "Reparto Degenze 3A", "lastLocationDate": "2026-06-12T09:30:00.000Z"}, {"id": "a_demo_06", "name": "Ecografo", "brand": "Esaote", "model": "MyLab X8", "serial": "DEMO-SN-006", "location": "Radiologia", "customerId": "c_demo_2", "status": "operativo", "lastService": "2025-08-14", "nextService": "2026-08-14", "serviceInterval": 12, "riskClass": "IIa", "iecNorm": "62353", "iecClass": "I", "patientType": "BF", "notes": "Apparecchio di esempio", "photos": [], "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "intervalIec": 12, "intervalFunc": 12, "deleted": false, "deletedAt": null, "assetCode": "AST-006", "manufactureDate": "2021-03-01", "commissionDate": "2021-06-15", "purchaseCost": null, "supplier": "Fornitore Demo S.r.l.", "replacementDate": null, "batteryDate": null, "batteryChanged": false, "lastSeenAt": null, "epc": "E28011700000000000000006", "lastLocation": "", "lastLocationDate": ""}, {"id": "a_demo_07", "name": "Aspiratore chirurgico", "brand": "Cheiron", "model": "New Askir 30", "serial": "DEMO-SN-007", "location": "Ambulatorio 4", "customerId": "c_demo_3", "status": "operativo", "lastService": "2025-09-13", "nextService": "2026-09-13", "serviceInterval": 12, "riskClass": "IIa", "iecNorm": "62353", "iecClass": "I", "patientType": "BF", "notes": "Apparecchio di esempio", "photos": [], "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "intervalIec": 12, "intervalFunc": 12, "deleted": false, "deletedAt": null, "assetCode": "AST-007", "manufactureDate": "2021-03-01", "commissionDate": "2021-06-15", "purchaseCost": null, "supplier": "Fornitore Demo S.r.l.", "replacementDate": null, "batteryDate": null, "batteryChanged": false, "lastSeenAt": null, "epc": "E28011700000000000000007", "lastLocation": "", "lastLocationDate": ""}, {"id": "a_demo_08", "name": "Incubatrice neonatale", "brand": "Dräger", "model": "Caleo", "serial": "DEMO-SN-008", "location": "Neonatologia", "customerId": "c_demo_1", "status": "operativo", "lastService": "2025-07-03", "nextService": "2026-07-03", "serviceInterval": 12, "riskClass": "IIb", "iecNorm": "62353", "iecClass": "I", "patientType": "BF", "notes": "Apparecchio di esempio", "photos": [], "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "intervalIec": 12, "intervalFunc": 12, "deleted": false, "deletedAt": null, "assetCode": "AST-008", "manufactureDate": "2021-03-01", "commissionDate": "2021-06-15", "purchaseCost": null, "supplier": "Fornitore Demo S.r.l.", "replacementDate": null, "batteryDate": null, "batteryChanged": false, "lastSeenAt": null, "epc": "E28011700000000000000008", "lastLocation": "Neonatologia", "lastLocationDate": "2026-06-07T09:30:00.000Z"}, {"id": "a_demo_09", "name": "Pulsossimetro", "brand": "Masimo", "model": "Radical-7", "serial": "DEMO-SN-009", "location": "Day Hospital", "customerId": "c_demo_3", "status": "operativo", "lastService": "2025-10-13", "nextService": "2026-10-13", "serviceInterval": 12, "riskClass": "IIa", "iecNorm": "62353", "iecClass": "II", "patientType": "BF", "notes": "Apparecchio di esempio", "photos": [], "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "intervalIec": 12, "intervalFunc": 12, "deleted": false, "deletedAt": null, "assetCode": "AST-009", "manufactureDate": "2021-03-01", "commissionDate": "2021-06-15", "purchaseCost": null, "supplier": "Fornitore Demo S.r.l.", "replacementDate": null, "batteryDate": null, "batteryChanged": false, "lastSeenAt": null, "epc": "E28011700000000000000009", "lastLocation": "", "lastLocationDate": ""}, {"id": "a_demo_10", "name": "Elettrocardiografo", "brand": "Mortara", "model": "ELI 280", "serial": "DEMO-SN-010", "location": "Ambulatorio 2", "customerId": "c_demo_3", "status": "fuori servizio", "lastService": "2025-06-12", "nextService": "2026-06-12", "serviceInterval": 12, "riskClass": "IIa", "iecNorm": "62353", "iecClass": "I", "patientType": "CF", "notes": "Apparecchio di esempio", "photos": [], "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "intervalIec": 12, "intervalFunc": 12, "deleted": false, "deletedAt": null, "assetCode": "AST-010", "manufactureDate": "2021-03-01", "commissionDate": "2021-06-15", "purchaseCost": null, "supplier": "Fornitore Demo S.r.l.", "replacementDate": null, "batteryDate": null, "batteryChanged": false, "lastSeenAt": null, "epc": "E2801170000000000000000A", "lastLocation": "Ambulatorio 2", "lastLocationDate": "2026-06-14T09:30:00.000Z"}, {"id": "a_demo_11", "name": "Lampada scialitica", "brand": "Trumpf", "model": "TruLight 5000", "serial": "DEMO-SN-011", "location": "Blocco Operatorio 1", "customerId": "c_demo_1", "status": "operativo", "lastService": "2025-12-12", "nextService": "2026-12-12", "serviceInterval": 12, "riskClass": "I", "iecNorm": "62353", "iecClass": "I", "patientType": "B", "notes": "Apparecchio di esempio", "photos": [], "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "intervalIec": 12, "intervalFunc": 12, "deleted": false, "deletedAt": null, "assetCode": "AST-011", "manufactureDate": "2021-03-01", "commissionDate": "2021-06-15", "purchaseCost": null, "supplier": "Fornitore Demo S.r.l.", "replacementDate": null, "batteryDate": null, "batteryChanged": false, "lastSeenAt": null, "epc": "E2801170000000000000000B", "lastLocation": "", "lastLocationDate": ""}, {"id": "a_demo_12", "name": "Autoclave a vapore", "brand": "W&H", "model": "Lisa 22", "serial": "DEMO-SN-012", "location": "Sterilizzazione", "customerId": "c_demo_2", "status": "operativo", "lastService": "2025-07-30", "nextService": "2026-07-30", "serviceInterval": 12, "riskClass": "IIb", "iecNorm": "62353", "iecClass": "I", "patientType": "B", "notes": "Apparecchio di esempio", "photos": [], "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "intervalIec": 12, "intervalFunc": 12, "deleted": false, "deletedAt": null, "assetCode": "AST-012", "manufactureDate": "2021-03-01", "commissionDate": "2021-06-15", "purchaseCost": null, "supplier": "Fornitore Demo S.r.l.", "replacementDate": null, "batteryDate": null, "batteryChanged": false, "lastSeenAt": null, "epc": "E2801170000000000000000C", "lastLocation": "", "lastLocationDate": ""}], "iecReports": [{"id": "R453118", "reportNumber": "VSE-2026-008", "assetId": "a_demo_01", "customerId": "c_demo_1", "jobId": null, "norm": "62353", "equipClass": "II", "patientType": "B", "leakageMethod": "diretto", "verifyType": "periodica", "verifyStatus": "completata", "measures": [{"id": "ins_main", "name": "Resistenza isolamento — rete vs accessibili (500 Vdc)", "unit": "MΩ", "limit": "≥ 7", "value": "999", "limitVal": 7, "invertPass": true}, {"id": "ins_pa", "name": "Resistenza isolamento parte applicata — rete (500 Vdc)", "unit": "MΩ", "limit": "≥ 2", "value": "999", "limitVal": 2, "invertPass": true}, {"id": "id_eq", "name": "Equipment Leakage Cl.II (metodo diretto)", "unit": "µA", "limit": "≤ 100", "value": "5.3", "limitVal": 100}], "overallPass": true, "technician": "Mario Rossi", "techSignature": "", "deptSignature": "", "date": "2026-05-16", "notes": "", "createdAt": "2026-05-30T07:51:12.654+00:00", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null, "calNumber": "", "departmentContact": "", "departmentName": "Reparto Cardiologia", "departmentSignature": "", "equipType": "", "instrument": "Fluke ESA612 (demo)", "notAvailableReason": "", "technicianSignature": "", "visual": {"docs": null, "cable": true, "labels": true, "housing": true, "connectors": true}, "instrumentSerial": "DEMO-CAL-01", "instrumentCalExpiry": null, "published": true}, {"id": "R663785", "reportNumber": "VSE-2026-009", "assetId": "a_demo_02", "customerId": "c_demo_1", "jobId": null, "norm": "62353", "equipClass": "III", "patientType": "B", "leakageMethod": "diretto", "verifyType": "periodica", "verifyStatus": "completata", "measures": [{"id": "ins_pa", "name": "Resistenza isolamento parte applicata — rete (500 Vdc)", "unit": "MΩ", "limit": "≥ 2", "value": "999", "limitVal": 2, "invertPass": true}], "overallPass": true, "technician": "Mario Rossi", "techSignature": "", "deptSignature": "", "date": "2026-05-19", "notes": "", "createdAt": "2026-05-30T07:54:37.799+00:00", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null, "calNumber": "", "departmentContact": "", "departmentName": "Reparto Cardiologia", "departmentSignature": "", "equipType": "", "instrument": "Fluke ESA612 (demo)", "notAvailableReason": "", "technicianSignature": "", "visual": {"docs": null, "cable": true, "labels": true, "housing": true, "connectors": true}, "instrumentSerial": "DEMO-CAL-01", "instrumentCalExpiry": null, "published": true}, {"id": "R876997", "reportNumber": "VSE-2026-010", "assetId": "a_demo_03", "customerId": "c_demo_1", "jobId": null, "norm": "62353", "equipClass": "II", "patientType": "B", "leakageMethod": "diretto", "verifyType": "periodica", "verifyStatus": "completata", "measures": [{"id": "ins_main", "name": "Resistenza isolamento — rete vs accessibili (500 Vdc)", "unit": "MΩ", "limit": "≥ 7", "value": "999", "limitVal": 7, "invertPass": true}, {"id": "ins_pa", "name": "Resistenza isolamento parte applicata — rete (500 Vdc)", "unit": "MΩ", "limit": "≥ 2", "value": "999", "limitVal": 2, "invertPass": true}, {"id": "id_eq", "name": "Equipment Leakage Cl.II (metodo diretto)", "unit": "µA", "limit": "≤ 100", "value": "3.2", "limitVal": 100}], "overallPass": true, "technician": "Mario Rossi", "techSignature": "", "deptSignature": "", "date": "2026-05-22", "notes": "", "createdAt": "2026-05-30T07:58:16.962+00:00", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null, "calNumber": "", "departmentContact": "", "departmentName": "Reparto Cardiologia", "departmentSignature": "", "equipType": "", "instrument": "Fluke ESA612 (demo)", "notAvailableReason": "", "technicianSignature": "", "visual": {"docs": null, "cable": true, "labels": true, "housing": true, "connectors": true}, "instrumentSerial": "DEMO-CAL-01", "instrumentCalExpiry": null, "published": true}, {"id": "R147230", "reportNumber": "VSE-2026-011", "assetId": "a_demo_04", "customerId": "c_demo_2", "jobId": null, "norm": "62353", "equipClass": "II", "patientType": "B", "leakageMethod": "diretto", "verifyType": "periodica", "verifyStatus": "completata", "measures": [{"id": "ins_main", "name": "Resistenza isolamento — rete vs accessibili (500 Vdc)", "unit": "MΩ", "limit": "≥ 7", "value": "999", "limitVal": 7, "invertPass": true}, {"id": "ins_pa", "name": "Resistenza isolamento parte applicata — rete (500 Vdc)", "unit": "MΩ", "limit": "≥ 2", "value": "999", "limitVal": 2, "invertPass": true}, {"id": "id_eq", "name": "Equipment Leakage Cl.II (metodo diretto)", "unit": "µA", "limit": "≤ 100", "value": "6.3", "limitVal": 100}], "overallPass": true, "technician": "Mario Rossi", "techSignature": "", "deptSignature": "", "date": "2026-05-25", "notes": "", "createdAt": "2026-05-30T08:02:45.437+00:00", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null, "calNumber": "", "departmentContact": "", "departmentName": "Reparto Cardiologia", "departmentSignature": "", "equipType": "", "instrument": "Fluke ESA612 (demo)", "notAvailableReason": "", "technicianSignature": "", "visual": {"docs": null, "cable": true, "labels": true, "housing": true, "connectors": true}, "instrumentSerial": "DEMO-CAL-01", "instrumentCalExpiry": null, "published": true}, {"id": "R323342", "reportNumber": "VSE-2026-012", "assetId": "a_demo_05", "customerId": "c_demo_2", "jobId": null, "norm": "62353", "equipClass": "II", "patientType": "B", "leakageMethod": "diretto", "verifyType": "periodica", "verifyStatus": "completata", "measures": [{"id": "ins_main", "name": "Resistenza isolamento — rete vs accessibili (500 Vdc)", "unit": "MΩ", "limit": "≥ 7", "value": "999", "limitVal": 7, "invertPass": true}, {"id": "ins_pa", "name": "Resistenza isolamento parte applicata — rete (500 Vdc)", "unit": "MΩ", "limit": "≥ 2", "value": "999", "limitVal": 2, "invertPass": true}, {"id": "id_eq", "name": "Equipment Leakage Cl.II (metodo diretto)", "unit": "µA", "limit": "≤ 100", "value": "6.2", "limitVal": 100}], "overallPass": true, "technician": "Mario Rossi", "techSignature": "", "deptSignature": "", "date": "2026-05-28", "notes": "", "createdAt": "2026-05-30T08:05:42.952+00:00", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null, "calNumber": "", "departmentContact": "", "departmentName": "Reparto Cardiologia", "departmentSignature": "", "equipType": "", "instrument": "Fluke ESA612 (demo)", "notAvailableReason": "", "technicianSignature": "", "visual": {"docs": null, "cable": true, "labels": true, "housing": true, "connectors": true}, "instrumentSerial": "DEMO-CAL-01", "instrumentCalExpiry": null, "published": true}, {"id": "R528316", "reportNumber": "VSE-2026-013", "assetId": "a_demo_06", "customerId": "c_demo_2", "jobId": null, "norm": "62353", "equipClass": "II", "patientType": "B", "leakageMethod": "diretto", "verifyType": "periodica", "verifyStatus": "completata", "measures": [{"id": "ins_main", "name": "Resistenza isolamento — rete vs accessibili (500 Vdc)", "unit": "MΩ", "limit": "≥ 7", "value": "999", "limitVal": 7, "invertPass": true}, {"id": "ins_pa", "name": "Resistenza isolamento parte applicata — rete (500 Vdc)", "unit": "MΩ", "limit": "≥ 2", "value": "999", "limitVal": 2, "invertPass": true}, {"id": "id_eq", "name": "Equipment Leakage Cl.II (metodo diretto)", "unit": "µA", "limit": "≤ 100", "value": "6.8", "limitVal": 100}], "overallPass": true, "technician": "Mario Rossi", "techSignature": "", "deptSignature": "", "date": "2026-05-31", "notes": "", "createdAt": "2026-05-30T08:09:06.162+00:00", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null, "calNumber": "", "departmentContact": "", "departmentName": "Reparto Cardiologia", "departmentSignature": "", "equipType": "", "instrument": "Fluke ESA612 (demo)", "notAvailableReason": "", "technicianSignature": "", "visual": {"docs": null, "cable": true, "labels": true, "housing": true, "connectors": true}, "instrumentSerial": "DEMO-CAL-01", "instrumentCalExpiry": null, "published": true}], "funcReports": [{"id": "FV700933", "reportNumber": "VF-2026-001", "assetId": "a_demo_04", "customerId": "c_demo_2", "jobId": "11f463b4-7243-4c83-84bd-ce8009404312", "templateId": "pulsossimetro", "verifyType": "periodica", "verifyStatus": "completata", "sections": {"allarmi": {"items": {"all_audio": true, "all_pausa": true, "all_fc_low": true, "all_visivo": true, "all_fc_high": true, "all_sensore": true, "all_spo2_low": true, "all_spo2_high": true}, "measures": {}}, "registro": {"items": {"data_ora": true, "trasferimento": "na", "memorizzazione": "na", "registro_aggiornato": true}, "measures": {}}, "ispezione": {"items": {"sensore": true, "batteria": true, "cavo_paz": true, "alimentaz": "na", "etichette": true, "involucro": true}, "measures": {}}, "perfusione": {"items": {}, "measures": {}, "_sectionNA": true}, "alimentazione": {"items": {}, "measures": {}, "_sectionNA": true}, "accuratezza_fc": {"items": {}, "measures": {"fc_30": "30", "fc_60": "60", "fc_120": "120", "fc_200": "200"}}, "accuratezza_spo2": {"items": {"morf_pleth": true, "simulatore": true}, "measures": {"spo2_70": "70", "spo2_80": "80", "spo2_90": "90", "spo2_97": "97"}}}, "overallPass": true, "technician": "Mario Rossi", "techSignature": "", "deptSignature": "", "date": "2026-05-30", "notes": "", "createdAt": "2026-05-30T09:03:24.557+00:00", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null, "departmentContact": "", "departmentName": "Reparto Cardiologia", "departmentSignature": "", "instrument": "", "notAvailableReason": "", "technicianSignature": "", "instrumentSerial": null, "instrumentCalExpiry": null, "published": true}, {"id": "FV846699", "reportNumber": "VF-2026-002", "assetId": "a_demo_05", "customerId": "c_demo_2", "jobId": "49b67f10-abe6-4c74-929c-7373dd58f499", "templateId": "pulsossimetro", "verifyType": "periodica", "verifyStatus": "completata", "sections": {"allarmi": {"items": {"all_audio": true, "all_pausa": true, "all_fc_low": true, "all_visivo": "na", "all_fc_high": true, "all_sensore": true, "all_spo2_low": true, "all_spo2_high": true}, "measures": {}}, "registro": {"items": {"data_ora": "na", "trasferimento": "na", "memorizzazione": "na", "registro_aggiornato": true}, "measures": {}}, "ispezione": {"items": {"sensore": true, "batteria": true, "cavo_paz": true, "alimentaz": true, "etichette": true, "involucro": true}, "measures": {}}, "perfusione": {"items": {}, "measures": {}, "_sectionNA": true}, "alimentazione": {"items": {"low_batt": "na"}, "measures": {}, "_sectionNA": true}, "accuratezza_fc": {"items": {}, "measures": {"fc_30": "30", "fc_60": "60", "fc_120": "120", "fc_200": "200"}}, "accuratezza_spo2": {"items": {"morf_pleth": true, "simulatore": true}, "measures": {"spo2_70": "70", "spo2_80": "80", "spo2_90": "90", "spo2_97": "97"}}}, "overallPass": true, "technician": "Mario Rossi", "techSignature": "", "deptSignature": "", "date": "2026-05-30", "notes": "", "createdAt": "2026-05-30T09:05:06.627+00:00", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null, "departmentContact": "", "departmentName": "Reparto Cardiologia", "departmentSignature": "", "instrument": "", "notAvailableReason": "", "technicianSignature": "", "instrumentSerial": null, "instrumentCalExpiry": null, "published": true}], "instruments": [{"id": "I1779807985468", "brand": "Datrend", "model": "VPad 2 Rugged", "serial": "DEMO-CAL-01", "internalCode": "STR-01", "category": "Tester IEC/Sicurezza elettrica", "calDate": "2025-03-26", "calExpiry": "2026-06-01", "calLab": "Lab Taratura Demo", "certNumber": "CERT-DEMO-001", "notes": "Strumento di esempio", "createdAt": "2026-06-01T14:25:39.646376+00:00", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null, "calInterval": 12}], "jobs": [{"id": "j_demo_01", "assetId": "a_demo_02", "customerId": "c_demo_1", "type": "correttiva", "priority": "urgente", "status": "aperto", "assignee": "Mario Rossi", "openDate": "2026-06-14", "closeDate": null, "description": "Allarme pressione vie aeree ricorrente — da verificare sensore", "parts": [], "laborHours": 2.0, "laborRate": 35.0, "timeline": [], "photos": [], "iecReportId": null, "funcReportId": null, "notes": "", "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null, "travelCost": 0, "purged": false}, {"id": "j_demo_02", "assetId": "a_demo_10", "customerId": "c_demo_3", "type": "correttiva", "priority": "alta", "status": "in corso", "assignee": "Mario Rossi", "openDate": "2026-06-13", "closeDate": null, "description": "ECG non si accende — sospetto alimentatore", "parts": [], "laborHours": 1.5, "laborRate": 35.0, "timeline": [], "photos": [], "iecReportId": null, "funcReportId": null, "notes": "", "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null, "travelCost": 0, "purged": false}, {"id": "j_demo_03", "assetId": "a_demo_01", "customerId": "c_demo_1", "type": "preventiva", "priority": "normale", "status": "aperto", "assignee": "Mario Rossi", "openDate": "2026-06-15", "closeDate": null, "description": "Manutenzione preventiva + controllo batteria defibrillatore", "parts": [], "laborHours": 1.0, "laborRate": 35.0, "timeline": [], "photos": [], "iecReportId": null, "funcReportId": null, "notes": "", "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null, "travelCost": 0, "purged": false}, {"id": "j_demo_04", "assetId": "a_demo_05", "customerId": "c_demo_2", "type": "verifica", "priority": "normale", "status": "da accettare", "assignee": "Mario Rossi", "openDate": "2026-06-15", "closeDate": null, "description": "Richiesta sicurezza elettrica annuale pompa infusione", "parts": [], "laborHours": 0.5, "laborRate": 35.0, "timeline": [], "photos": [], "iecReportId": null, "funcReportId": null, "notes": "", "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null, "travelCost": 0, "purged": false}, {"id": "j_demo_05", "assetId": "a_demo_08", "customerId": "c_demo_1", "type": "preventiva", "priority": "normale", "status": "aperto", "assignee": "Mario Rossi", "openDate": "2026-06-12", "closeDate": null, "description": "Taratura sonda temperatura incubatrice", "parts": [], "laborHours": 1.0, "laborRate": 35.0, "timeline": [], "photos": [], "iecReportId": null, "funcReportId": null, "notes": "", "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null, "travelCost": 0, "purged": false}, {"id": "j_demo_06", "assetId": "a_demo_03", "customerId": "c_demo_1", "type": "correttiva", "priority": "bassa", "status": "chiuso", "assignee": "Mario Rossi", "openDate": "2026-05-26", "closeDate": "2026-05-28", "description": "Sostituzione pedale elettrobisturi — completato", "parts": [], "laborHours": 1.5, "laborRate": 35.0, "timeline": [], "photos": [], "iecReportId": null, "funcReportId": null, "notes": "", "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null, "travelCost": 0, "purged": false}, {"id": "j_demo_07", "assetId": "a_demo_04", "customerId": "c_demo_2", "type": "preventiva", "priority": "normale", "status": "chiuso", "assignee": "Mario Rossi", "openDate": "2026-05-31", "closeDate": "2026-05-31", "description": "Manutenzione preventiva monitor — completato", "parts": [], "laborHours": 1.0, "laborRate": 35.0, "timeline": [], "photos": [], "iecReportId": null, "funcReportId": null, "notes": "", "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null, "travelCost": 0, "purged": false}], "parts": [{"id": "p_demo_1", "code": "BAT-DEF-01", "name": "Batteria defibrillatore (demo)", "qty": 4, "minQty": 2, "price": 180.0, "location": "Magazzino A", "supplier": "Fornitore Demo S.r.l.", "notes": "", "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null}, {"id": "p_demo_2", "code": "FLT-VENT-02", "name": "Filtro antibatterico ventilatore (demo)", "qty": 25, "minQty": 10, "price": 12.5, "location": "Magazzino A", "supplier": "Fornitore Demo S.r.l.", "notes": "", "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null}, {"id": "p_demo_3", "code": "ELE-NEU-01", "name": "Elettrodo neutro monouso (demo)", "qty": 120, "minQty": 50, "price": 3.2, "location": "Magazzino B", "supplier": "Fornitore Demo S.r.l.", "notes": "", "createdAt": "2026-06-15T08:00:00.000Z", "updatedAt": "2026-06-15T08:00:00.000Z", "orgId": "demo", "deleted": false, "deletedAt": null}], "orders": [], "withdrawals": [], "invoices": [], "quotes": [], "procedures": [], "customTemplates": {}, "cestino": {}, "_meta": {"version": "2.05", "app": "MedTrace", "demo": true, "note": "Dati di esempio — anonimi"}};
...
const FORM_SECTION = { fontSize: 11, color: "#2F9E8E", fontWeight: 800, marginBottom: 12, marginTop: 4, textTransform: "uppercase", letterSpacing: .8, display: "flex", alignItems: "center", gap: 6 };
const FORM_BTN_PRIMARY = { background: "#2F9E8E", color: "#06251f", border: "none", borderRadius: 9, padding: "11px 22px", cursor: "pointer", fontWeight: 800, fontSize: 14, boxShadow: "none" };
...
body { background: linear-gradient(90deg, #0E7490 0mm, #2F9E8E 8mm, #fff 8mm); background-repeat: no-repeat; }
.side { display: none; }
...
<div class="kv"><span class="kv-label">Prossima verifica</span><span class="kv-value">${(function(){ var nd = rep.nextDate; if (!nd && rep.date && asset && asset.intervalIec){ var d = new Date(rep.date); if(!isNaN(d.getTime())){ d.setMonth(d.getMonth()+(parseInt(asset.intervalIec,10)||12)); nd=d.toISOString().slice(0,10);} } return nd || '—'; })()}</span></div>
...
<div class="kv"><span class="kv-label">Ubicazione</span><span class="kv-value">${(asset === null || asset === void 0 ? void 0 : asset.location) || "—"}</span></div>
<div class="kv"><span class="kv-label">N° Inventario</span><span class="kv-value" style="font-family:monospace">${(asset && asset.assetCode) || "—"}</span></div>
<div class="kv"><span class="kv-label">Prossima verifica</span><span class="kv-value">${(function(){ var nd = rep.nextDate; if (!nd && rep.date && asset && asset.intervalFunc){ var d = new Date(rep.date); if(!isNaN(d.getTime())){ d.setMonth(d.getMonth()+(parseInt(asset.intervalFunc,10)||12)); nd=d.toISOString().slice(0,10);} } return nd || "—"; })()}</span></div>
${(customer === null || customer === void 0 ? void 0 : customer.name) ? `<div class="kv"><span class="kv-label">Cliente</span><span class="kv-value">${customer.name}</span></div>` : ""}
...
const PILL = on => ({ background: on ? "#2F9E8E22" : "var(--surface-3)", border: "1px solid " + (on ? "#2F9E8E" : "var(--border)"), color: on ? "#2F9E8E" : "var(--text-2)", borderRadius: 8, padding: "6px 11px", fontSize: 12.5, cursor: "pointer", fontWeight: 600 });
...
React.createElement("button", { type: "button", onClick: addManual, style: { background: "var(--surface-3)", border: "1px solid var(--border)", borderRadius: 8, color: "#2F9E8E", padding: "0 14px", fontSize: 18, cursor: "pointer", fontWeight: 700 } }, "+")),
...
list.map(nm => (React.createElement("span", { key: nm, style: { display: "inline-flex", alignItems: "center", gap: 6, background: "#2F9E8E18", border: "1px solid #2F9E8E55", color: "#2F9E8E", borderRadius: 8, padding: "4px 4px 4px 9px", fontSize: 12, fontWeight: 600 } },
nm,
React.createElement("button", { type: "button", onClick: () => setList(list.filter(x => x.toLowerCase() !== nm.toLowerCase())), title: "Rimuovi", style: { background: "transparent", border: "none", color: "#2F9E8E", fontSize: 13, lineHeight: 1, cursor: "pointer", padding: "0 4px" } }, "\u2715"))))))));
}
...
React.createElement("button", { type: "button", onClick: add, style: { background: "#2F9E8E", border: "none", borderRadius: 8, color: "#04201C", padding: "0 16px", fontSize: 14, fontWeight: 800, cursor: "pointer" } }, "Aggiungi"))));
}
...
const __expEl = React.createElement("span", { style: { fontSize: 10, color: "var(--text-2)", fontFamily: "monospace" } }, m.expected || m.limit || "");
...
(isMobile ? React.createElement("div", { style: { background: fail ? "#3a0f0f" : "var(--bg)", borderRadius: 6, padding: "8px 10px", opacity: isNA ? 0.55 : 1, border: fail ? "2px solid #ef4444" : "1px solid var(--border-2)" } }, React.createElement("div", { style: { marginBottom: 7 } }, __nameEl), React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" } }, React.createElement("span", { style: { fontSize: 10, color: "var(--text-2)", fontFamily: "monospace", flex: "1 1 60px", minWidth: 0 } }, m.expected || m.limit || ""), __inputEl, __unitEl, __naBtn)) : React.createElement("div", { style: { display: "grid", gridTemplateColumns: "minmax(0,1fr) 90px 60px 38px 30px", gap: 6, alignItems: "center", background: fail ? "#3a0f0f" : "var(--bg)", borderRadius: 6, padding: "6px 8px", opacity: isNA ? 0.55 : 1, border: fail ? "2px solid #ef4444" : "1px solid var(--border-2)" } }, __nameEl, __expEl, __inputEl, __unitEl, __naBtn)),
...
" \u2014 ",
tpl.norm),
React.createElement("span", { style: { fontWeight: 900, fontSize: 15, letterSpacing: .3, color: pass ? "#04201C" : "#fff", background: pass ? "#2F9E8E" : "#ef4444", borderRadius: 6, padding: "5px 12px", whiteSpace: "nowrap" } }, pass ? "CONFORME" : "NON CONFORME")),
...
React.createElement("div", { style: { fontSize: 11, color: isNA ? "var(--text-3)" : "#6FC2B5", textTransform: "uppercase", letterSpacing: .8, fontWeight: 700, textDecoration: isNA ? "line-through" : "none" } },
sec.title,
isNA && " (N/A)"),
...
sec.note && React.createElement("div", { style: { fontSize: 10, color: "var(--text-3)", marginBottom: 10, fontStyle: "italic" } }, sec.note),
...
const C = { box: "#1a2030", boxStroke: "#3a4560", wireRef: "#ef4444", wireProbe: "var(--text-strong)", wirePA: "#a855f7", txt: "var(--text)", sub: "var(--text-2)" };
...
return Object.assign(Object.assign({}, init), { measures: getMeasures(init.norm || "62353", "I", init.patientType || "BF", init.leakageMethod || "diretto", init.sfc !== false, init.fixedInstall), visual: init.visual || { housing: null, cable: null, connectors: null, labels: null, docs: null } });
...
const LBL = { fontSize: 10, color: "var(--text-3)", textTransform: "uppercase", letterSpacing: .8, fontWeight: 700 };
const INP = { background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 8, padding: "9px 11px", color: "var(--text)", fontSize: 13, outline: "none", width: "100%", boxSizing: "border-box" };
const isMobile = useMedia("(max-width:600px)");
return (React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 14 } },
React.createElement(ErrorSummary, { errors: errors }),
...
React.createElement("span", { style: { fontWeight: 900, fontSize: 15, letterSpacing: .3, color: f.overallPass ? "#04201C" : "#fff", background: f.overallPass ? "#2F9E8E" : "#ef4444", borderRadius: 6, padding: "5px 12px", whiteSpace: "nowrap" } }, f.overallPass ? "CONFORME" : "NON CONFORME")),
f.norm === "62353" && (React.createElement("div", { style: { background: "var(--bg)", border: "1px solid #2F9E8E44", borderRadius: 8, padding: "10px 14px", fontSize: 11, color: "#9090A8", lineHeight: 1.5 } },
React.createElement("div", { style: { color: "#2F9E8E", fontWeight: 700, marginBottom: 4, fontSize: 11 } }, "\u2139 IEC 62353:2014 \u2014 Limiti test periodico"),
...
React.createElement("div", { style: { marginTop: 4, paddingTop: 4, borderTop: "1px solid #2F9E8E22", color: "var(--text-2)" } },
...
" \u22652 M\u03A9"))),
f.norm === "60601" && (React.createElement("div", { style: { background: "var(--bg)", border: "1px solid #2F9E8E44", borderRadius: 8, padding: "10px 14px", fontSize: 11, color: "#9090A8", lineHeight: 1.5 } },
React.createElement("div", { style: { color: "#2F9E8E", fontWeight: 700, marginBottom: 4, fontSize: 11 } }, "\u2139 IEC 60601-1 \u2014 Prova approfondita (NC + Primo Guasto)"),
React.createElement("div", null,
...
color: f.verifyStatus === "completata" ? "#22c55e" : "var(--text-2)",
borderRadius: 7, padding: "10px", cursor: "pointer", fontSize: 12, fontWeight: 700,
touchAction: "manipulation", WebkitTapHighlightColor: "transparent"
} }, "\u2713 Verifica completata"),
React.createElement("button", { type: "button", onClick: () => setF(x => (Object.assign(Object.assign({}, x), { verifyStatus: "non_disponibile" }))), style: {
...
f.norm === "62353" && f.equipClass !== "III" && (React.createElement("div", { style: Object.assign(Object.assign({}, FLD), { gridColumn: "1 / -1", background: f.fixedInstall ? "#2F9E8E12" : "transparent", borderRadius: 8, padding: f.fixedInstall ? "8px 10px" : 0 }) },
...
React.createElement("span", { style: { width: 42, height: 24, borderRadius: 999, background: f.fixedInstall ? "#2F9E8E" : "var(--border)", position: "relative", transition: "background .15s", flexShrink: 0, display: "inline-block" } },
...
React.createElement("span", { style: { fontSize: 13, fontWeight: 600, color: f.fixedInstall ? "#6FC2B5" : "var(--text)" } },
...
f.fixedInstall && React.createElement("div", { style: { fontSize: 11, color: "#6FC2B5", marginTop: 6, marginLeft: 25 } }, "Misure adattate: terra su nodo equipotenziale, dispersione d'involucro al posto dell'equipment leakage."))),
...
React.createElement("button", { type: "button", onClick: () => setF(x => (Object.assign(Object.assign({}, x), { sfc: !(x.sfc !== false) }))), style: { display: "flex", alignItems: "center", gap: 10, background: "var(--surface)", border: "1px solid " + ((f.sfc !== false) ? "#2F9E8E66" : "var(--border)"), borderRadius: 7, padding: "10px 12px", cursor: "pointer", touchAction: "manipulation", WebkitTapHighlightColor: "transparent" } },
React.createElement("div", { style: { width: 38, height: 22, borderRadius: 11, background: (f.sfc !== false) ? "#2F9E8E" : "var(--border)", position: "relative", flexShrink: 0 } },
...
React.createElement("span", { style: { fontSize: 12, fontWeight: 700, color: (f.sfc !== false) ? "#2F9E8E" : "var(--text-2)" } }, (f.sfc !== false) ? "Incluse (NC + SFC)" : "Escluse (solo NC)")),
...
prevReport && (React.createElement("div", { style: { fontSize: 10.5, color: "#6FC2B5", background: "#2F9E8E12", border: "1px solid #2F9E8E33", borderRadius: 6, padding: "6px 10px", marginBottom: 4 } },
...
isMobile ? (React.createElement("div", { style: { marginBottom: 8, background: "var(--bg)", borderRadius: 8, padding: "10px 12px" } },
...
tutorialFor(m.id, f.fixedInstall) && React.createElement("span", { onClick: () => setTutorialOpen(tutorialOpen === m.id ? null : m.id), title: "Come mi collego", style: { cursor: "pointer", color: "#2F9E8E", border: "1px solid #2F9E8E66", borderRadius: "50%", width: 20, height: 20, minWidth: 20, display: "inline-flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 700, flexShrink: 0 } }, "i")),
...
isOptional(m.id) && React.createElement("button", { onClick: () => toggleNA(m.id), style: { marginTop: 8, background: m.na ? "#2F9E8E22" : "transparent", border: "1px solid " + (m.na ? "#2F9E8E66" : "var(--border)"), borderRadius: 6, color: m.na ? "#6FC2B5" : "var(--text-3)", fontSize: 11, fontWeight: 700, padding: "5px 12px", cursor: "pointer" } }, m.na ? "✓ Non applicabile (tocca per misurare)" : "Segna come non applicabile (N/A)"))) : (React.createElement("div", { style: { display: "grid", gridTemplateColumns: prevReport ? "minmax(0,1fr) 70px 80px 50px 56px 44px" : "minmax(0,1fr) 90px 90px 56px 56px", gap: 8, alignItems: "center", marginBottom: 6, background: "var(--bg)", borderRadius: 6, padding: "7px 10px", opacity: m.na ? .5 : 1 } },
...
tutorialFor(m.id, f.fixedInstall) && React.createElement("span", { onClick: () => setTutorialOpen(tutorialOpen === m.id ? null : m.id), title: "Come mi collego", style: { cursor: "pointer", color: "#2F9E8E", border: "1px solid #2F9E8E66", borderRadius: "50%", width: 16, height: 16, minWidth: 16, display: "inline-flex", alignItems: "center", justifyContent: "center", fontSize: 10, fontWeight: 700, flexShrink: 0 } }, "i"),
isOptional(m.id) && React.createElement("span", { onClick: () => toggleNA(m.id), title: m.na ? "Misura segnata non applicabile — tocca per riattivare" : "Segna come non applicabile (prova opzionale)", style: { cursor: "pointer", fontSize: 9, fontWeight: 700, padding: "2px 6px", borderRadius: 4, border: "1px solid " + (m.na ? "#2F9E8E" : "var(--border)"), color: m.na ? "#6FC2B5" : "var(--text-4)", background: m.na ? "#2F9E8E18" : "transparent", flexShrink: 0 } }, "N/A")),
m.editableLimit ? (React.createElement("input", { type: "text", disabled: m.na, value: m.limit, onChange: e => setF(x => (Object.assign(Object.assign({}, x), { measures: x.measures.map(mm => mm.id === m.id ? Object.assign(Object.assign({}, mm), { limit: e.target.value, limitVal: parseFloat(String(e.target.value).replace(/[^0-9.]/g, "")) || mm.limitVal }) : mm) }))), title: "Limite modificabile", style: { background: "var(--surface-2)", border: "1px solid #2F9E8E44", borderRadius: 5, padding: "4px 6px", color: "#6FC2B5", fontSize: 11, fontFamily: "monospace", width: "100%", outline: "none" } })) : (React.createElement("span", { style: { fontSize: 11, color: "var(--text-3)", fontFamily: "monospace" } }, m.limit)),
React.createElement("input", { type: "number", step: "0.001", disabled: m.na, value: m.na ? "" : m.value, onChange: e => setMeas(m.id, e.target.value), placeholder: m.na ? "N/A" : "—", style: { background: "var(--card)", border: "1px solid var(--border)", borderRadius: 5, padding: "4px 7px", color: "var(--text)", fontSize: 12, outline: "none", fontFamily: "monospace", minWidth: 0 } }),
...
React.createElement("span", { style: { fontSize: 11, color: "var(--text-3)", fontFamily: "monospace", textAlign: "center" } }, prevVal !== null ? prevVal : "—"),
...
return (React.createElement("div", { key: m.id + "-tut", style: { background: "var(--surface)", border: "1px solid #2F9E8E", borderRadius: 10, padding: "14px 16px", marginBottom: 10, marginTop: 4, boxShadow: "0 4px 14px rgba(0,0,0,.4)" } },
React.createElement("div", { style: { fontSize: 13, fontWeight: 800, color: "#6FC2B5", marginBottom: 10, paddingBottom: 8, borderBottom: "1px solid #2F9E8E33" } }, "\uD83D\uDD0C Come mi collego"),
...
"tavolo_operatorio": {
label: "Tavolo operatorio", icon: "›", norm: "IEC 60601-2-46:2023",
sections: [
...
"autoclave": {
label: "Autoclave / sterilizzatrice a vapore", icon: "›", norm: "EN 13060:2025",
sections: [
{ id: "ispezione", title: "Ispezione visiva e meccanica", items: [
...
"dae": {
label: "Defibrillatore Automatico Esterno", icon: "›", norm: "IEC 60601-2-4:2010+AMD1:2018 / D.Lgs. 53/2021",
sections: [
{
...
const HELP_SECTIONS = [
{
icon: "◈", title: "Dashboard", color: "#2F9E8E",
steps: [
...
{
icon: "›", title: "Apparecchi (Parco Macchine)", color: "#2F9E8E",
steps: [
...
{
icon: "›", title: "Ricognizione RFID", color: "#2F9E8E",
steps: [
"A cosa serve: fai il giro di un reparto, scansioni in blocco i tag RFID degli apparecchi presenti e aggiorni in automatico la loro ultima posizione. La voce 'Ricognizione' è nel gruppo APPARECCHIATURE.",
...
{
icon: "›", title: "Preventivi", color: "#2F9E8E",
steps: [
...
{
icon: "›", title: "Cestino", color: "#6FC2B5",
steps: [
...
{
icon: "›", title: "Strumenti di Misura", color: "#2F9E8E",
steps: [
...
{
icon: "›", title: "Procedure / Knowledge Base", color: "#2F9E8E",
steps: [
...
{
icon: "›", title: "Gesti Mobile e PWA", color: "#2F9E8E",
steps: [
...
{
icon: "›", title: "Account e Sincronizzazione Cloud", color: "#2F9E8E",
steps: [
...
{
icon: "›", title: "Report parco macchine (per cliente)", color: "#2F9E8E",
steps: [
...
{
icon: "›", title: "Filtri e Ricerca", color: "#2F9E8E",
steps: [
...
{
icon: "›", title: "Ruoli e permessi", color: "#6FC2B5",
steps: [
...
{
icon: "›", title: "Privacy, dati e note legali", color: "#2F9E8E",
steps: [
...
const colorFor = days => days < 0 ? "#ef4444" : days <= 7 ? "#f97316" : days <= 30 ? "#f59e0b" : "#2F9E8E";
...
React.createElement("span", { style: { fontSize: 9, fontWeight: 700, color: s.tipoKind === "iec" ? "#c084fc" : "#6FC2B5", background: (s.tipoKind === "iec" ? "#a855f7" : "#1F7468") + "22", border: "1px solid " + (s.tipoKind === "iec" ? "#a855f7" : "#1F7468") + "44", borderRadius: 4, padding: "1px 6px" } }, s.tipoKind === "iec" ? "Sic. Elettrica" : "Funzionale")),
...
flex: 1, background: on ? "#1F7468" : "var(--card)", border: "1px solid " + (on ? "#2F9E8E" : "var(--border-3)"),
...
gruppi.length,
" clienti"),
React.createElement("button", { onClick: exportAll, style: { background: "#2F9E8E15", border: "1px solid #2F9E8E44", borderRadius: 7, color: "#2F9E8E", padding: "8px 13px", fontSize: 12, fontWeight: 700, cursor: "pointer" } }, "\uD83D\uDCCA Esporta tutto in Excel"))),
...
React.createElement("button", { onClick: () => exportCustomer(g), title: "Scarica Excel di questo cliente", style: { background: "#2F9E8E12", border: "1px solid #2F9E8E44", borderRadius: 6, color: "#2F9E8E", padding: "6px 10px", fontSize: 11, fontWeight: 700, cursor: "pointer", whiteSpace: "nowrap" } }, "\uD83D\uDCCA Excel"),
React.createElement("button", { onClick: () => onEmail(g), disabled: !hasCust, title: hasCust ? "Email al cliente con elenco in scadenza" : "Nessun cliente assegnato", style: { background: hasCust ? "#2F9E8E15" : "var(--surface-2)", border: "1px solid " + (hasCust ? "#2F9E8E44" : "var(--border)"), borderRadius: 6, color: hasCust ? "#2F9E8E" : "var(--text-4)", padding: "6px 10px", fontSize: 11, fontWeight: 700, cursor: hasCust ? "pointer" : "default", whiteSpace: "nowrap" } }, "\u2709 Promemoria"))),
g.items.map(Row)));
}))));
}
...
React.createElement("button", { onClick: exportExcel, style: { background: "#2F9E8E15", border: "1px solid #2F9E8E44", borderRadius: 8, color: "#2F9E8E", padding: "10px 14px", fontSize: 12.5, fontWeight: 700, cursor: "pointer", width: "100%" } },
...
React.createElement("a", { href: mailtoUrl, style: { background: "#2F9E8E", border: "none", borderRadius: 7, color: "#04201C", padding: "9px 15px", fontSize: 12.5, fontWeight: 800, cursor: "pointer", textDecoration: "none" } }, "\u2709 Apri nell'app email"))));
}
...
React.createElement("div", { style: { fontWeight: 700, color: "#2F9E8E", marginBottom: 6, fontSize: 13 } }, "Nota"),
...
const TH_S = { background: "var(--bg-2)", color: "var(--text-3)", padding: "8px 10px", textAlign: "left", fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: .7, borderBottom: "2px solid var(--border-2)", borderRight: "1px solid var(--border-2)", whiteSpace: "nowrap", cursor: "pointer", userSelect: "none", position: "sticky", top: 0, zIndex: 2 };
const TD_S = { padding: "7px 10px", borderBottom: "1px solid var(--border-2)", borderRight: "1px solid var(--border-2)", fontSize: 12, color: "#C8C8D8", whiteSpace: "nowrap", maxWidth: 200, overflow: "hidden", textOverflow: "ellipsis", verticalAlign: "middle" };
...
React.createElement("span", { style: { marginLeft: "auto", fontSize: 11, color: "var(--text-4)", fontFamily: "monospace" } },
filtered.length,
"/",
rows.length),
...
}, style: { background: "#2F9E8E15", border: "1px solid #2F9E8E44", borderRadius: 5, color: "#2F9E8E", padding: "5px 10px", fontSize: 11, fontWeight: 700, cursor: "pointer", whiteSpace: "nowrap" }, title: "Esporta in Excel i risultati filtrati" }, "\u2B07 Excel"))),
...
cols.map(c => (React.createElement("th", { key: c.key, style: Object.assign(Object.assign({}, TH_S), { color: sort.key === c.key ? "#6FC2B5" : "var(--text-3)", whiteSpace: isMobile ? "nowrap" : "normal" }), onClick: () => toggleSort(c.key) },
c.label,
" ",
...
React.createElement("button", { onClick: () => { setOptSearch(""); setOpenCol(open ? null : c.key); }, title: sel.length ? sel.join(", ") : "Filtra", style: { display: "flex", alignItems: "center", gap: 4, width: "100%", background: sel.length ? "#2F9E8E18" : "var(--card)", border: "1px solid " + (sel.length ? "#2F9E8E66" : "var(--border-2)"), borderRadius: 4, padding: "3px 6px", color: sel.length ? "#6FC2B5" : "var(--text-2)", fontSize: 11, cursor: "pointer", outline: "none", whiteSpace: "nowrap", overflow: "hidden" } },
...
? { position: "fixed", left: 0, right: 0, bottom: 0, zIndex: 41, maxHeight: "62vh", overflowY: "auto", background: "var(--card)", borderTop: "1px solid #2F9E8E44", borderRadius: "16px 16px 0 0", boxShadow: "0 -8px 30px rgba(0,0,0,.6)", padding: "14px 14px calc(14px + env(safe-area-inset-bottom))" }
: { position: "absolute", top: "calc(100% + 3px)", left: 0, zIndex: 41, minWidth: 180, maxWidth: 260, maxHeight: 280, overflowY: "auto", background: "var(--card)", border: "1px solid #2F9E8E44", borderRadius: 8, boxShadow: "0 8px 24px rgba(0,0,0,.5)", padding: 6 } },
...
React.createElement("button", { onClick: () => setAll(c.key, optSearch ? present.filter(o => o.toLowerCase().includes(optSearch.toLowerCase())) : present), style: { flex: 1, background: "none", border: "1px solid #2F9E8E44", borderRadius: 4, color: "#6FC2B5", fontSize: 10, fontWeight: 700, padding: "3px 0", cursor: "pointer" } }, optSearch ? "Tutti i visibili" : "Tutti"),
...
React.createElement("span", { style: { width: 15, height: 15, flexShrink: 0, borderRadius: 3, border: "1px solid " + (sel.indexOf(o) >= 0 ? "#2F9E8E" : "var(--text-4)"), background: sel.indexOf(o) >= 0 ? "#2F9E8E" : "transparent", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10, color: "var(--bg-deep)", fontWeight: 900 } }, sel.indexOf(o) >= 0 ? "✓" : ""),
React.createElement("span", { style: { flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" } }, c.render ? c.render(o, {}) : o),
React.createElement("span", { style: { fontSize: 10, color: "var(--text-4)", fontFamily: "monospace" } }, counts[o]))));
})())))));
...
const bg = rowBg ? rowBg(row) : (i % 2 === 1 ? "var(--bg)" : "transparent");
...
const Spinner = ({ size = 18, color = "#2F9E8E" }) => (React.createElement("span", { style: {
...
background: open ? "#2F9E8E" : "transparent",
border: "1px solid " + (open ? "#2F9E8E" : "var(--text-4)"),
...
background: a.primary ? "#2F9E8E" : "transparent",
...
React.createElement("span", { style: { fontSize: 10, color: "var(--text-4)", fontFamily: "monospace", whiteSpace: "nowrap" } },
count,
"/",
total)));
...
background: activeCount > 0 ? "#2F9E8E15" : "var(--bg-2)",
border: "1px solid " + (activeCount > 0 ? "#2F9E8E55" : "var(--border-2)"),
borderRadius: 10, padding: "9px 14px",
color: activeCount > 0 ? "#2F9E8E" : "var(--text-2)", fontSize: 13, fontWeight: 700,
cursor: "pointer", touchAction: "manipulation", WebkitTapHighlightColor: "transparent"
} },
React.createElement("span", { style: { display: "flex", alignItems: "center", gap: 8 } },
"Filtri ",
activeCount > 0 && React.createElement("span", { style: { background: "#2F9E8E", color: "#000", borderRadius: 10, padding: "1px 8px", fontSize: 11, fontWeight: 800 } }, activeCount)),
...
React.createElement("div", { style: { flex: 1, minWidth: 0 } },
React.createElement("div", { style: { color: "var(--text)", fontSize: 13, fontWeight: 600, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" } }, selected.name),
...
background: isHigh ? "#2F9E8E11" : (isSel ? "var(--border-2)" : "transparent"),
borderLeft: isSel ? "3px solid #2F9E8E" : "3px solid transparent",
transition: "all .1s"
} },
React.createElement("div", { style: { color: "var(--text)", fontSize: 13, fontWeight: 600, lineHeight: 1.3 } }, a.name),
...
const vars = {
primary: { background: "#2F9E8E", color: "#fff", boxShadow: "none" },
...
function BarChart({ data, height = 160, color = "#2F9E8E" }) {
if (!data.length)
return null;
...
msg && React.createElement("div", { style: { fontSize: 11.5, color: msg.indexOf("✗") === 0 || msg.indexOf("⚠") === 0 ? "#f59e0b" : "#2F9E8E", marginTop: 9, lineHeight: 1.5 } }, msg),
...
return { nAssets: myAssets.length, confPct, conformi, nonConformi, maiVerificati, scaduti, d30, d60, d90, mttr, nChiusi: chiusi.length, ritorniPct, months, top, topCust, mtbf, nGuasti, completPct, nOpenedP: openedInP.length, nClosedP: closedOfThose.length, prevN, corrN, pmPct };
...
React.createElement("p", { style: { color: "var(--text-3)", margin: isMobile ? 0 : "2px 0 0", fontSize: 12, fontFamily: "monospace" } },
K.nAssets,
...
React.createElement("div", { style: sub }, "MTBF \u00b7 tra guasti"),
...
React.createElement("div", { style: sub }, "Tasso completamento"),
...
React.createElement("div", { style: sub }, "Quota preventiva"),
...
"(",
React.createElement("span", { style: { color: "#2F9E8E" } }, "\u25A0 prev."),
" ",
...
React.createElement(Bar, { h: 86 * m.prev / maxMix, color: "#2F9E8E" }),
...
React.createElement(Bar, { h: 86 * m.ver / maxVer, color: "#6FC2B5" }),
React.createElement("div", { style: { fontSize: 9, color: "var(--text-3)", textAlign: "center", marginTop: 3 } },
m.label,
React.createElement("br", null),
m.ver || ""))))))),
...
t.name,
" ",
t.code ? React.createElement("span", { style: { fontFamily: "monospace", fontSize: 11, color: "#2F9E8E" } }, t.code) : null),
...
"Parti da zero? ",
React.createElement("a", { href: "#", onClick: e => { e.preventDefault(); scaricaTemplate(); }, style: { color: "#2F9E8E" } }, "Scarica il modello Excel"),
...
React.createElement("div", { style: { width: 46, height: 27, borderRadius: 14, flexShrink: 0, background: f.batteryChanged ? "#2F9E8E" : "#3a4151", position: "relative", transition: "background .15s" } },
...
React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 8 } }, assets.map(a => (React.createElement("button", { key: a.id, onClick: () => toggle(a.id), style: { background: f.compatible.includes(a.id) ? "#2F9E8E22" : "var(--surface-2)", border: "1px solid " + (f.compatible.includes(a.id) ? "#2F9E8E" : "var(--surface-4)"), color: f.compatible.includes(a.id) ? "#6FC2B5" : "var(--text-3)", borderRadius: 8, padding: "6px 12px", cursor: "pointer", fontSize: 12 } },
(a.assetCode || a.id),
" \u2014 ",
a.name)))))),
React.createElement(Span2, null,
...
f.timeline.map((step, i) => (React.createElement("div", { key: step.id || i, style: { background: "var(--bg)", border: "1px solid var(--border-2)", borderLeft: "3px solid #2F9E8E", borderRadius: 8, padding: "10px 12px" } },
...
React.createElement("input", { type: "number", min: 0, step: 5, value: step.durationMin, onChange: e => setStep(i, "durationMin", e.target.value), placeholder: "min", style: { background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 6, padding: "6px 9px", color: "var(--text)", fontSize: 12, fontFamily: "monospace" } })),
...
(job.parts || []).length,
" pezzi")),
React.createElement("div", { style: { flex: 1, minWidth: 120, background: "#2F9E8E12", borderRadius: 10, padding: "10px 14px", border: "1px solid #2F9E8E33" } },
React.createElement("div", { style: { fontSize: 9.5, color: "#6FC2B5", textTransform: "uppercase", letterSpacing: .6, fontWeight: 700 } }, "Totale"),
React.createElement("div", { style: { fontSize: 16, fontWeight: 900, color: "#2F9E8E", marginTop: 3 } },
"\u20AC ",
(partsTot + laborTot).toFixed(2))))),
React.createElement("div", null,
...
React.createElement("div", { style: { width: 34, height: 34, borderRadius: "50%", background: "#2F9E8E22", border: "1px solid #2F9E8E44", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, flexShrink: 0 } }, TIMELINE_ICON[step.type] || "·"),
...
React.createElement("span", { style: { color: "#6FC2B5", fontWeight: 700, fontSize: 13 } }, TIMELINE_LABEL[step.type] || step.type),
...
React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center" } },
React.createElement("div", { style: { width: 36, height: 36, borderRadius: "50%", background: "#2F9E8E22", border: "1px solid #2563eb44", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16 } }, TIMELINE_ICON[step.type] || "·"),
...
kind: "job", date: j.openDate || "", color: STATUS_COLOR[j.status] || "var(--text-3)",
...
" ",
asset.model),
React.createElement("div", { style: { fontSize: 11, color: "var(--text-3)", fontFamily: "monospace", marginBottom: customer ? 4 : 10 } },
"S/N: ",
asset.serial || "—",
" \u00B7 Codice: ",
...
React.createElement("button", { onClick: onEditAsset, style: { background: "var(--surface-2)", color: "var(--text)", border: "1px solid var(--border)", borderRadius: 7, padding: "8px 6px", cursor: "pointer", fontSize: 12, fontWeight: 700, touchAction: "manipulation", WebkitTapHighlightColor: "transparent" } }, "\u270F Modifica"),
React.createElement("button", { onClick: onNewJob, style: { background: "#2F9E8E", color: "var(--bg-deep)", border: "none", borderRadius: 7, padding: "8px 6px", cursor: "pointer", fontSize: 12, fontWeight: 800, touchAction: "manipulation", WebkitTapHighlightColor: "transparent" } }, "+ Job"),
...
React.createElement("button", { onClick: onAssetSticker, style: { background: "var(--surface-2)", color: "#c084fc", border: "1px solid #a855f744", borderRadius: 7, padding: "8px 6px", cursor: "pointer", fontSize: 12, fontWeight: 700, touchAction: "manipulation", WebkitTapHighlightColor: "transparent" } }, "\uD83C\uDFF7 Sticker"),
...
onQuickLocation(loc.trim()); }, style: { background: "var(--surface-2)", color: "#2F9E8E", border: "1px solid #2F9E8E44", borderRadius: 7, padding: "8px 6px", cursor: "pointer", fontSize: 12, fontWeight: 700, touchAction: "manipulation", WebkitTapHighlightColor: "transparent" } }, "\uD83D\uDCCD Posizione"))),
...
{ label: "Job totali", value: assetJobs.length, color: "#2F9E8E" },
...
React.createElement("div", { style: { display: "flex", gap: 4, marginBottom: 12, borderBottom: "2px solid var(--border-2)", paddingBottom: 0 } }, TABS.map(t => (React.createElement("button", { key: t.id, onClick: () => setTab(t.id), style: {
background: "none", border: "none", borderBottom: tab === t.id ? "2px solid #3b82f6" : "2px solid transparent",
color: tab === t.id ? "#6FC2B5" : "var(--text-3)", padding: "7px 12px", cursor: "pointer",
...
[["Marca", asset.brand], ["Modello", asset.model], ["N° Serie", asset.serial], ["Ubicazione", asset.location]].map(([l, v]) => v ? (React.createElement("div", { key: l, style: { display: "flex", justifyContent: "space-between", padding: "4px 0", borderBottom: "1px solid var(--border)" } },
React.createElement("span", { style: { fontSize: 11, color: "var(--text-3)" } }, l),
React.createElement("span", { style: { fontSize: 11, color: "var(--text)", fontFamily: l === "N° Serie" ? "monospace" : "inherit" } }, v))) : null)),
React.createElement("div", { style: S },
...
React.createElement("span", { style: { fontSize: 11, color: "var(--text)", fontFamily: "monospace" } }, asset.epc)),
asset.lastLocation
? React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline" } },
React.createElement("span", { style: { fontSize: 11, color: "var(--text-3)" } }, "Ultima posizione"),
React.createElement("span", { style: { fontSize: 12.5, color: "#2F9E8E", fontWeight: 700 } }, asset.lastLocation + (asset.lastLocationDate ? (" \u00B7 " + fmtDateTimeIt(asset.lastLocationDate)) : "")))
: React.createElement("div", { style: { fontSize: 11, color: "var(--text-3)", fontStyle: "italic" } }, "Tag associato, mai scansionato"))
...
asset.notes))),
tab === "timeline" && (React.createElement("div", { style: { overflow: "auto", maxHeight: "55vh" } }, timelineEvents.length === 0 ? (React.createElement("div", { style: { textAlign: "center", padding: 32, color: "var(--text-4)" } }, "Nessun evento registrato per questo apparecchio")) : (React.createElement("div", { style: { position: "relative", paddingLeft: 18 } },
...
React.createElement("div", { style: { background: "var(--surface)", border: "1px solid var(--border-2)", borderRadius: 8, padding: "9px 13px" } },
...
React.createElement("span", { style: { fontSize: 11, color: "var(--text-3)", fontFamily: "monospace", flexShrink: 0, whiteSpace: "nowrap" } }, e.date || "—")))))))))),
tab === "jobs" && (React.createElement("div", { style: { overflow: "auto", maxHeight: "55vh", display: "flex", flexDirection: "column", gap: 8 } }, assetJobs.length === 0 ? (React.createElement("div", { style: { textAlign: "center", padding: 32, color: "var(--text-4)" } }, "Nessun job per questo apparecchio")) : assetJobs.map(j => {
var _a;
...
React.createElement("span", { style: { fontFamily: "monospace", fontSize: 11, color: "var(--text-3)" } }, jobShortCode(j)),
...
j.timeline.length,
" step"),
(j.iecReportId || j.funcReportId) && React.createElement("div", { style: { fontSize: 10, color: "#6FC2B5" } },
j.iecReportId ? "⚡" : "",
j.funcReportId ? "🩺" : "")))));
}))),
tab === "iec" && (React.createElement("div", { style: { overflow: "auto", maxHeight: "55vh", display: "flex", flexDirection: "column", gap: 8 } }, assetIec.length === 0 ? (React.createElement("div", { style: { textAlign: "center", padding: 32, color: "var(--text-4)" } }, "Nessuna verifica di sicurezza elettrica per questo apparecchio")) : assetIec.map(r => (React.createElement("div", { key: r.id, style: { background: "var(--surface)", border: "1px solid " + (r.overallPass ? "#22c55e33" : "#ef444433"), borderRadius: 8, padding: "10px 14px" } },
...
React.createElement("span", { style: { fontFamily: "monospace", fontWeight: 700, color: "var(--text)" } }, r.reportNumber || r.id),
React.createElement("span", { style: { fontSize: 10, color: "var(--text-3)" } },
r.norm,
" \u00B7 Cl.",
r.equipClass,
...
React.createElement("button", { onClick: () => generateIECPDF(r, asset, customer, company), style: { background: "var(--surface-3)", border: "1px solid var(--border)", borderRadius: 5, color: "#6FC2B5", padding: "3px 8px", cursor: "pointer", fontSize: 11 } })))))))),
tab === "func" && (React.createElement("div", { style: { overflow: "auto", maxHeight: "55vh", display: "flex", flexDirection: "column", gap: 8 } }, assetFunc.length === 0 ? (React.createElement("div", { style: { textAlign: "center", padding: 32, color: "var(--text-4)" } }, "Nessuna verifica funzionale per questo apparecchio")) : assetFunc.map(r => {
const tpl = (templates || FUNC_TEMPLATES || {})[r.templateId] || { label: "Generico", icon: "›" };
return (React.createElement("div", { key: r.id, style: { background: "var(--surface)", border: "1px solid " + (r.overallPass ? "#22c55e33" : "#ef444433"), borderRadius: 8, padding: "10px 14px" } },
React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 } },
React.createElement("div", null,
React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center", marginBottom: 3 } },
React.createElement("span", { style: { fontFamily: "monospace", fontWeight: 700, color: "var(--text)" } }, r.reportNumber || r.id),
...
React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center" } },
React.createElement("span", { style: { fontWeight: 800, fontSize: 13, color: r.overallPass ? "#22c55e" : "#ef4444" } }, r.overallPass ? "✓ OK" : "✗ NO"),
React.createElement("button", { onClick: () => generateFuncPDF(r, asset, customer, company), style: { background: "var(--surface-3)", border: "1px solid var(--border)", borderRadius: 5, color: "#6FC2B5", padding: "3px 8px", cursor: "pointer", fontSize: 11 } })))));
})))));
}
...
border: "1px solid " + (on ? "#2F9E8E" : "var(--border-3)"), borderRadius: 9, padding: "10px 8px",
...
activeRoleObj.desc,
React.createElement("span", { style: { display: "block", marginTop: 4, color: "#6FC2B5", fontWeight: 700 } },
enabledCount,
" sezioni visibili su ",
...
React.createElement("strong", { style: { color: "#6FC2B5" } }, "ripristinarli"),
" o eliminarli ",
...
React.createElement("button", { onClick: () => onRestore(t.key, rec.id), style: { background: "#2F9E8E18", border: "1px solid #2F9E8E55", color: "#6FC2B5", borderRadius: 7, padding: "6px 12px", fontSize: 12, cursor: "pointer", whiteSpace: "nowrap", fontWeight: 600 } }, "\u21A9 Ripristina"),
...
msg && React.createElement("div", { style: { fontSize: 11.5, color: msg.indexOf("✗") !== -1 ? "#f59e0b" : "#2F9E8E", marginTop: 8 } }, msg)));
}
...
React.createElement("div", { style: { color: "#2F9E8E", fontWeight: 700, marginBottom: 8 } }, "Risultato scansione"),
...
React.createElement("span", { style: { background: "#2F9E8E15", color: "#2F9E8E", border: "1px solid #2F9E8E44", borderRadius: 9, padding: "9px 16px", cursor: "pointer", fontSize: 13, fontWeight: 700, display: "inline-block" } }, comp.logo ? "Cambia logo" : "Carica logo")),
...
React.createElement("div", { style: { width: 42, height: 25, borderRadius: 13, flexShrink: 0, background: comp.logoHasName ? "#2F9E8E" : "#3a4151", opacity: isAdmin ? 1 : 0.5, position: "relative", transition: "background .15s" } },
...
background: comp.stickerPrompt ? "#2F9E8E" : "#3a4151",
...
React.createElement("strong", { style: { color: "#6FC2B5" } }, "Superuser"),
...
React.createElement("span", { style: { color: "#6FC2B5", fontSize: 18 } }, "\u203A")))),
isLogged ? (React.createElement(Section, { icon: "\u2601\uFE0F", title: "Sincronizzazione cloud", color: "#2F9E8E", accent: "#2F9E8E33" },
React.createElement("div", { style: { color: "var(--text-2)", fontSize: 12, lineHeight: 1.55, marginBottom: 14 } },
"I dati vengono ",
React.createElement("strong", { style: { color: "#6FC2B5" } }, "uniti"),
...
cloudStatus && (React.createElement("div", { style: { marginTop: 12, fontSize: 12, color: cloudStatus.startsWith("✗") ? "#ef4444" : "#2F9E8E", lineHeight: 1.5, background: (cloudStatus.startsWith("✗") ? "#ef444410" : "#2F9E8E10"), borderRadius: 8, padding: "9px 12px" } }, cloudStatus)))) : (React.createElement(Section, { icon: "\uD83D\uDCBE", title: "Dove sono i dati" },
...
return (React.createElement("div", { style: { background: "var(--card)", border: "1px solid var(--border-2)", borderRadius: 14, padding: "14px 16px", marginTop: 12 } },
React.createElement("div", { style: { fontSize: 13, fontWeight: 700, marginBottom: 6 } }, "\uD83E\uDDF9 Pulizia job di archivio"),
React.createElement("div", { style: { fontSize: 12, color: "var(--text-2)", lineHeight: 1.5, marginBottom: 10 } },
...
React.createElement("b", { style: { color: "#6FC2B5" } }, archJobs.length),
"."),
...
React.createElement("span", { style: { fontSize: 12.5, color: "var(--text)", fontWeight: 700 } },
fmtMB(u.chars),
" usati"),
...
". Questo \u00E8 il ",
React.createElement("strong", { style: { color: '#2F9E8E' } }, "codice invito"),
...
catch (e) { } }, style: { background: 'var(--bg)', border: '1px dashed #2F9E8E66', borderRadius: 10, padding: '14px 10px', fontFamily: 'monospace', fontSize: 20, fontWeight: 800, letterSpacing: 2, color: '#2F9E8E', cursor: 'pointer', marginBottom: 8, wordBreak: 'break-all' } }, createdCode),
React.createElement("div", { style: { fontSize: 11, color: copied ? '#2F9E8E' : '#5A5A70', marginBottom: 22 } }, copied ? '✓ Copiato negli appunti' : 'Tocca per copiare · Conservalo: serve ai colleghi per registrarsi'),
React.createElement("button", { onClick: () => { if (createdUser)
onLogin(createdUser);
else
window.location.reload(); }, style: { width: '100%', background: '#2F9E8E', color: '#000', border: 'none', borderRadius: 8, padding: 13, fontSize: 14, fontWeight: 800, cursor: 'pointer', fontFamily: 'inherit' } }, "Entra in MedTrace \u2192"))));
}
return (React.createElement("div", { style: { minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 } },
...
React.createElement("g", { fill: "none", stroke: "#2F9E8E", strokeLinecap: "round", strokeLinejoin: "round" },
...
React.createElement("circle", { cx: "42", cy: "24", r: "3.5", fill: "#2F9E8E", stroke: "none" })),
...
React.createElement("button", { onClick: () => { setMode('create'); setError(''); }, style: { background: 'none', border: 'none', color: '#2F9E8E', fontSize: 12, cursor: 'pointer', textDecoration: 'underline' } }, "Nuova ditta? Crea la tua organizzazione")))),
...
error && React.createElement("div", { style: { background: error.includes('email') ? '#2F9E8E18' : '#ef444418', border: `1px solid ${error.includes('email') ? '#2F9E8E44' : '#ef444444'}`, borderRadius: 8, padding: '10px 14px', fontSize: 13, color: error.includes('email') ? '#2F9E8E' : '#ef4444', marginBottom: 16 } }, error),
React.createElement("button", { onClick: handle, disabled: loading, style: { width: '100%', background: '#2F9E8E', color: '#000', border: 'none', borderRadius: 8, padding: 13, fontSize: 14, fontWeight: 800, cursor: loading ? 'wait' : 'pointer', opacity: loading ? .7 : 1, fontFamily: 'inherit' } }, loading ? 'Caricamento…' : mode === 'login' ? 'Accedi' : mode === 'create' ? 'Crea organizzazione' : 'Crea account'),
...
React.createElement("button", { onClick: () => downloadAttachment(att), title: "Scarica", style: { background: 'var(--surface-3)', border: '1px solid #2F9E8E44', borderRadius: 4, color: '#2F9E8E', padding: '3px 8px', cursor: 'pointer', fontSize: 10, fontWeight: 700 } }, "\u2B07"),
((_a = att.type) === null || _a === void 0 ? void 0 : _a.startsWith('image/')) && (React.createElement("button", { onClick: () => window.open(att.dataUrl, '_blank'), title: "Visualizza", style: { background: 'var(--surface-3)', border: '1px solid #2a3040', borderRadius: 4, color: 'var(--text-2)', padding: '3px 8px', cursor: 'pointer', fontSize: 10, fontWeight: 700 } }, "\uD83D\uDC41")),
...
background: 'var(--surface-2)', border: '1px dashed #2F9E8E44', borderRadius: 6, padding: '6px 14px',
color: '#2F9E8E', fontSize: 11, fontWeight: 700, opacity: uploading ? .5 : 1,
} },
...
React.createElement("p", { style: { color: "var(--text-3)", margin: "2px 0 0", fontSize: 12, fontFamily: "monospace" } },
instruments.length,
" strumenti \u00B7 ",
valid,
" validi \u00B7 ",
...
{ label: 'Totale', value: instruments.length, color: '#2F9E8E' },
...
inst.internalCode && React.createElement("div", { style: { fontSize: 11, color: "var(--text-3)", fontFamily: "monospace", marginBottom: 3 } },
"Codice: ",
inst.internalCode),
...
React.createElement("button", { onClick: (e) => { e.stopPropagation(); setModal({ type: 'renew', data: inst }); }, style: { flex: 1, background: "transparent", color: "#2F9E8E", border: "none", borderRight: "1px solid var(--border-2)", padding: "10px 4px", fontSize: 11, fontWeight: 700, cursor: "pointer", touchAction: "manipulation" } }, "\u21BB Rinnova"),
...
" ",
inst.model),
inst.internalCode && React.createElement("span", { style: { fontFamily: "monospace", fontSize: 10, color: "var(--text-3)", background: "var(--bg)", borderRadius: 4, padding: "1px 6px", border: "1px solid var(--border-2)" } }, inst.internalCode),
...
"S/N: ",
React.createElement("span", { style: { color: "var(--text-2)", fontFamily: "monospace" } }, inst.serial)),
inst.calDate && React.createElement("span", null,
"Ultima cal.: ",
React.createElement("span", { style: { color: "var(--text-2)", fontFamily: "monospace" } }, inst.calDate)),
...
"Cert.: ",
React.createElement("span", { style: { color: "var(--text-2)", fontFamily: "monospace" } }, inst.certNumber))),
...
React.createElement("div", { style: { display: "flex", gap: 6, flexShrink: 0 } },
React.createElement("button", { onClick: () => setModal({ type: 'renew', data: inst }), style: { background: "transparent", color: "#2F9E8E", border: "1px solid #2F9E8E44", borderRadius: 6, padding: "5px 12px", cursor: "pointer", fontSize: 11, fontWeight: 700 } }, "\u21BB Rinnova"),
...
React.createElement("div", { style: { fontSize: 11, color: '#2F9E8E', fontWeight: 700, marginBottom: 10, textTransform: 'uppercase', letterSpacing: 1 } }, "Dati Calibrazione"),
React.createElement("div", { style: ROW },
React.createElement("div", { style: COL },
...
const on = tipo === v;
return React.createElement("button", { key: v, onClick: () => setTipo(v), style: { flex: 1, background: on ? "#1F7468" : "var(--card)", border: "1px solid " + (on ? "#2F9E8E" : "var(--border-3)"), borderRadius: 8, padding: "9px 8px", cursor: "pointer", color: on ? "#04201C" : "var(--text-strong)", fontSize: 12, fontWeight: on ? 800 : 600 } }, l);
}))),
React.createElement("div", { style: { marginBottom: 12 } },
...
React.createElement("button", { onClick: usaComeProc, style: { background: "#2F9E8E", border: "none", borderRadius: 7, color: "#04201C", padding: "9px 16px", fontSize: 12.5, fontWeight: 800, cursor: "pointer" } }, "Usa come bozza procedura \u2192")))))));
}
...
React.createElement("div", { style: { display: 'flex', gap: 8, marginBottom: 14, flexWrap: 'wrap' } },
React.createElement("input", { value: search, onChange: e => setSearch(e.target.value), placeholder: "Cerca per modello, marca, categoria\u2026", style: { flex: 1, minWidth: 200, background: 'var(--surface)', border: '1px solid #2A2A38', borderRadius: 8, padding: '8px 12px', color: '#F0F0F5', fontSize: 13, outline: 'none' } }),
React.createElement("select", { value: filterCat, onChange: e => setFilterCat(e.target.value), style: { background: 'var(--surface)', border: '1px solid #2A2A38', borderRadius: 8, padding: '8px 12px', color: '#9090A8', fontSize: 12 } },
React.createElement("option", { value: "all" }, "Tutte le categorie"),
PROC_CATEGORIES.map(c => React.createElement("option", { key: c, value: c }, c))),
React.createElement("select", { value: filterType, onChange: e => setFilterType(e.target.value), style: { background: 'var(--surface)', border: '1px solid #2A2A38', borderRadius: 8, padding: '8px 12px', color: '#9090A8', fontSize: 12 } },
...
p.category && React.createElement("span", { style: { fontSize: 10, background: '#2F9E8E18', color: '#2F9E8E', border: '1px solid #2F9E8E33', borderRadius: 20, padding: '1px 8px', fontWeight: 700 } }, p.category),
...
proc.category && React.createElement("span", { style: { fontSize: 10, background: '#2F9E8E18', color: '#2F9E8E', border: '1px solid #2F9E8E33', borderRadius: 20, padding: '2px 10px', fontWeight: 700 } }, proc.category),
...
React.createElement("div", { style: { display: 'flex', gap: 6, flexShrink: 0 } },
React.createElement("button", { onClick: onEdit, style: { background: 'var(--surface-2)', border: '1px solid #2F9E8E44', borderRadius: 6, color: '#2F9E8E', padding: '6px 12px', cursor: 'pointer', fontSize: 11, fontWeight: 700 } }, "\u270F Modifica"),
...
" passi"),
!proc.steps || proc.steps.length === 0 ? (React.createElement("div", { style: { padding: 20, color: '#5A5A70', fontStyle: 'italic', textAlign: 'center' } }, "Nessun passo definito")) : proc.steps.map((step, i) => (React.createElement("div", { key: i, style: { background: 'var(--surface)', border: '1px solid #2A2A38', borderRadius: 10, padding: '14px 16px', marginBottom: 8 } },
React.createElement("div", { style: { display: 'flex', gap: 12, alignItems: 'flex-start' } },
React.createElement("div", { style: { background: '#2F9E8E', color: '#000', borderRadius: '50%', width: 28, height: 28, display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 900, fontSize: 13, flexShrink: 0 } }, i + 1),
React.createElement("div", { style: { flex: 1, minWidth: 0 } },
...
step.expectedValue && (React.createElement("div", { style: { background: 'var(--bg)', border: '1px solid #2F9E8E33', borderRadius: 6, padding: '6px 12px', marginTop: 6, fontSize: 12 } },
React.createElement("span", { style: { color: '#5A5A70', fontWeight: 700, marginRight: 6, fontSize: 10, textTransform: 'uppercase' } }, "Atteso:"),
React.createElement("span", { style: { color: '#2F9E8E', fontWeight: 700 } }, step.expectedValue))),
...
proc.notes && (React.createElement("div", { style: { background: 'var(--surface)', border: '1px solid #2A2A38', borderRadius: 10, padding: '14px 18px', marginBottom: 14, borderLeft: '4px solid #2F9E8E' } },
...
React.createElement("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 } },
React.createElement("div", { style: { fontSize: 12, color: '#2F9E8E', fontWeight: 700, textTransform: 'uppercase', letterSpacing: 1 } },
"Passi della procedura (",
(form.steps || []).length,
")"),
React.createElement("button", { type: "button", onClick: addStep, style: { background: '#2F9E8E', color: '#000', border: 'none', borderRadius: 6, padding: '5px 14px', cursor: 'pointer', fontSize: 11, fontWeight: 800 } }, "+ Aggiungi passo")),
(form.steps || []).length === 0 ? (React.createElement("div", { style: { padding: 20, background: 'var(--bg)', border: '1px dashed #2A2A38', borderRadius: 8, color: '#5A5A70', textAlign: 'center', fontSize: 12 } }, "Nessun passo. Clicca \"+ Aggiungi passo\" per iniziare.")) : form.steps.map((step, i) => (React.createElement("div", { key: i, style: { background: 'var(--bg)', border: '1px solid #2A2A38', borderRadius: 8, padding: 12, marginBottom: 8 } },
React.createElement("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 } },
React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: 8 } },
React.createElement("div", { style: { background: '#2F9E8E', color: '#000', borderRadius: '50%', width: 22, height: 22, display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 900, fontSize: 11 } }, i + 1),
...
React.createElement("button", { type: "button", onClick: () => updStep(i, 'image', ''), style: { background: 'var(--surface-2)', border: '1px solid #ef444433', borderRadius: 4, color: '#ef4444', padding: '3px 10px', cursor: 'pointer', fontSize: 11, fontWeight: 700 } }, "Rimuovi"))) : (React.createElement("label", { style: { display: 'inline-flex', alignItems: 'center', gap: 6, cursor: 'pointer', background: 'var(--surface)', border: '1px dashed #2F9E8E44', borderRadius: 6, padding: '5px 12px', color: '#2F9E8E', fontSize: 11, fontWeight: 700 } },
...
React.createElement("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 } },
React.createElement("span", { style: { fontSize: 11, color: '#2F9E8E', fontWeight: 700, textTransform: 'uppercase', letterSpacing: .8 } },
"\uD83D\uDD27 Manodopera (",
f.laborLines.length,
" voci)"),
React.createElement("button", { onClick: addLabor, style: { background: 'var(--surface-2)', border: '1px solid #2F9E8E44', borderRadius: 6, color: '#2F9E8E', padding: '4px 12px', cursor: 'pointer', fontSize: 11, fontWeight: 700 } }, "+ Voce")),
...
React.createElement("div", { style: { display: 'flex', flexWrap: 'wrap', gap: 5 } }, parts.filter(p => p.qty > 0 || true).map(p => (React.createElement("button", { key: p.id, onClick: () => addPartWarehouse(p), style: { background: 'var(--surface-2)', border: '1px solid #2A2A38', borderRadius: 6, color: '#9090A8', padding: '3px 9px', cursor: 'pointer', fontSize: 10 } },
"+ ",
p.name,
p.code ? ` (${p.code})` : '',
" \u2014 \u20AC",
...
{ label: 'Valore inviati', value: `€${valueOpen.toFixed(0)}`, color: '#2F9E8E' },
...
React.createElement("div", { style: { display: 'flex', gap: 8, marginBottom: 14, flexWrap: 'wrap' } },
React.createElement("input", { value: search, onChange: e => setSearch(e.target.value), placeholder: "Cerca numero, cliente\u2026", style: { flex: 1, minWidth: 180, background: 'var(--surface)', border: '1px solid #2A2A38', borderRadius: 8, padding: '8px 12px', color: '#F0F0F5', fontSize: 13, outline: 'none' } }),
React.createElement("select", { value: filterStatus, onChange: e => setFilterStatus(e.target.value), style: { background: 'var(--surface)', border: '1px solid #2A2A38', borderRadius: 8, padding: '8px 12px', color: '#9090A8', fontSize: 12 } },
...
filtered.length === 0 ? (React.createElement("div", { style: { textAlign: 'center', padding: 48, color: '#5A5A70', background: 'var(--surface)', borderRadius: 12, border: '1px solid #2A2A38' } }, quotes.length === 0 ? (React.createElement(React.Fragment, null,
...
React.createElement("button", { onClick: () => generateQuotePDF(q, customer, company, assets, jobs), style: { background: 'var(--surface)', border: '1px solid #2F9E8E44', borderRadius: 6, color: '#2F9E8E', padding: '4px 10px', cursor: 'pointer', fontSize: 11, fontWeight: 700 } }, "PDF"),
...
.header { background: linear-gradient(135deg, #2F9E8E, #1F7468); color: white; padding: 28px 32px; display: flex; justify-content: space-between; align-items: flex-start; }
...
.total-grand { display:flex; justify-content:space-between; font-size:16px; font-weight:900; color:#1F7468; padding-top:8px; border-top:2px solid #2F9E8E; margin-top:8px; }
...
color: days < 0 ? '#ef4444' : days <= 30 ? '#f59e0b' : '#2F9E8E',
...
background: view === id ? '#2F9E8E' : 'transparent',
...
" ",
viewYear),
monthOffset !== 0 && React.createElement("button", { onClick: () => setMonthOffset(0), style: { background: 'none', border: 'none', color: '#2F9E8E', fontSize: 10, cursor: 'pointer', padding: 0, marginTop: 2 } }, "\u21A9 Torna a oggi")),
React.createElement("button", { onClick: () => setMonthOffset(monthOffset + 1), style: { background: 'var(--surface)', border: '1px solid #2a3040', borderRadius: 8, color: 'var(--text-2)', padding: '7px 14px', cursor: 'pointer', fontSize: 16 } }, "\u203A")),
...
React.createElement("div", { style: { fontSize: 26, fontWeight: 900, color: '#2F9E8E', fontFamily: 'monospace', lineHeight: 1 } }, stats.total),
...
background: filterType === f.id ? '#2F9E8E22' : 'var(--surface)',
color: filterType === f.id ? '#2F9E8E' : 'var(--text-3)',
border: '1px solid ' + (filterType === f.id ? '#2F9E8E66' : 'var(--border)'),
...
g.overdue,
" scadute"),
React.createElement("span", { style: { background: '#2F9E8E22', color: '#2F9E8E', borderRadius: 20, padding: '1px 8px', fontSize: 10, fontWeight: 800 } },
g.events.length,
" totali"))),
...
React.createElement("span", { style: { background: '#2F9E8E22', color: '#2F9E8E', borderRadius: 20, padding: '1px 8px', fontSize: 10, fontWeight: 800 } }, w.events.length)),
...
cells.push(React.createElement("div", { key: day, style: { minHeight: 64, padding: '5px', borderRight: '1px solid var(--border-2)', borderBottom: '1px solid var(--border-2)', background: isToday ? '#2F9E8E0a' : 'transparent' } },
React.createElement("div", { style: { fontSize: 11, fontWeight: isToday ? 900 : 500, color: isToday ? '#2F9E8E' : 'var(--text-3)', marginBottom: 4 } }, day),
dayEvents.length > 0 && (React.createElement("div", { onClick: () => { setView('byWeek'); }, style: {
background: hasOverdue ? '#ef444422' : '#2F9E8E22',
color: hasOverdue ? '#ef4444' : '#2F9E8E',
border: '1px solid ' + (hasOverdue ? '#ef444444' : '#2F9E8E44'),
...
return (React.createElement("div", { style: {
background: isSelected ? '#2F9E8E15' : 'var(--bg)',
border: `1px solid ${isSelected ? '#2F9E8E66' : 'var(--border-4)'}`,
...
showSelect && (React.createElement("input", { type: "checkbox", checked: isSelected, readOnly: true, style: { accentColor: '#2F9E8E', cursor: 'pointer', flexShrink: 0 } })),
React.createElement("div", { style: { flex: 1, minWidth: 0 } },
...
!showSelect && (React.createElement("select", { value: getPlanned(asset) || '', onChange: e => setPlanned(asset.id, e.target.value), onClick: e => e.stopPropagation(), style: { background: 'var(--surface)', border: '1px solid #2A2A38', borderRadius: 4, color: '#9090A8', fontSize: 10, padding: '2px 4px', flexShrink: 0 } },
React.createElement("option", { value: "" }, "\u2014"),
...
React.createElement("select", { value: filterType, onChange: e => setFilterType(e.target.value), style: { background: 'var(--bg)', border: '1px solid #2A2A38', borderRadius: 6, padding: '5px 10px', color: '#9090A8', fontSize: 11 } },
React.createElement("option", { value: "all" }, "Tutte le categorie"),
categories.map(c => React.createElement("option", { key: c, value: c }, c))),
React.createElement("select", { value: filterLocation, onChange: e => setFilterLocation(e.target.value), style: { background: 'var(--bg)', border: '1px solid #2A2A38', borderRadius: 6, padding: '5px 10px', color: '#9090A8', fontSize: 11 } },
React.createElement("option", { value: "all" }, "Tutte le ubicazioni"),
locations.map(l => React.createElement("option", { key: l, value: l }, l))),
React.createElement("select", { value: filterCustomer, onChange: e => setFilterCustomer(e.target.value), style: { background: 'var(--bg)', border: '1px solid #2A2A38', borderRadius: 6, padding: '5px 10px', color: '#9090A8', fontSize: 11 } },
...
unplanned.length,
" non pianificati"))),
React.createElement("div", { style: { background: 'var(--surface)', border: `1px solid ${selectedIds.length > 0 ? '#2F9E8E44' : 'var(--border-4)'}`, borderRadius: 10, padding: '10px 14px', marginBottom: 14,
...
React.createElement("select", { value: bulkMonth, onChange: e => setBulkMonth(e.target.value), style: { background: 'var(--bg)', border: '1px solid #2A2A38', borderRadius: 6, padding: '5px 10px', color: '#F0F0F5', fontSize: 12 } },
...
React.createElement("button", { onClick: applyBulk, style: { background: '#2F9E8E', color: '#000', border: 'none', borderRadius: 6, padding: '6px 14px', cursor: 'pointer', fontSize: 11, fontWeight: 800 } }, "Applica")))),
...
return (React.createElement("div", { key: month, style: { background: 'var(--surface)', border: `1px solid ${items.length > 0 ? '#2F9E8E33' : 'var(--border-4)'}`, borderRadius: 10, overflow: 'hidden' } },
React.createElement("div", { style: { padding: '8px 12px', background: items.length > 0 ? '#2F9E8E15' : 'var(--surface-2)',
borderBottom: `1px solid ${items.length > 0 ? '#2F9E8E33' : 'var(--border-4)'}`,
...
items.length > 0 && (React.createElement("span", { style: { background: '#2F9E8E', color: '#000', borderRadius: 20, padding: '1px 7px', fontSize: 10, fontWeight: 900 } }, items.length))),
...
background: (color || 'var(--text-3)') + '22', color: color || 'var(--text-3)',
border: `1px solid ${color || 'var(--text-3)'}44`,
borderRadius: 20, padding: '2px 10px', fontSize: 11, fontWeight: 700,
textTransform: 'capitalize', whiteSpace: 'nowrap',
} }, text));
if (!customer && customers.length === 0) {
return (React.createElement("div", { style: { minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, flexDirection: 'column', gap: 16 } },
React.createElement("div", { style: { background: 'var(--surface)', border: '1px solid #2A2A38', borderRadius: 14, padding: '32px 40px', textAlign: 'center', maxWidth: 400 } },
...
React.createElement("button", { onClick: onExit, style: { background: '#2F9E8E', color: '#000', border: 'none', borderRadius: 8, padding: '10px 22px', fontWeight: 800, fontSize: 13, cursor: 'pointer' } }, "\u2190 Torna all'app"))));
}
return (React.createElement("div", { style: { minHeight: '100vh', background: 'var(--bg)', fontFamily: "'Segoe UI',system-ui,sans-serif" } },
React.createElement("div", { style: { background: '#2F9E8E', color: '#000', padding: '7px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: 11, fontWeight: 700, flexWrap: 'wrap', gap: 6 } },
...
React.createElement("div", { style: { background: 'var(--surface)', borderBottom: '1px solid #2A2A38', padding: '10px 16px', display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' } },
React.createElement("span", { style: { color: '#5A5A70', fontSize: 12, fontWeight: 700 } }, "Anteprima come cliente:"),
React.createElement("select", { value: selectedCustomerId, onChange: e => setSelectedCustomerId(e.target.value), style: { background: 'var(--bg)', border: '1px solid #2A2A38', borderRadius: 6, padding: '5px 12px', color: '#F0F0F5', fontSize: 13, fontWeight: 700 } }, customers.map(c => React.createElement("option", { key: c.id, value: c.id }, c.name))),
...
React.createElement("div", { style: { background: 'var(--surface)', borderBottom: '1px solid #2A2A38', padding: '16px 20px' } },
...
React.createElement("g", { fill: "none", stroke: "#2F9E8E", strokeWidth: "2.5", strokeLinecap: "round" },
...
React.createElement("circle", { cx: "38", cy: "20", r: "4", fill: "#2F9E8E" }))),
React.createElement("div", { style: { flex: 1, minWidth: 0 } },
...
React.createElement("div", { style: { background: '#2F9E8E18', border: '1px solid #2F9E8E33', borderRadius: 20, padding: '4px 12px', fontSize: 10, color: '#2F9E8E', fontWeight: 700 } }, "\u25CF ONLINE"))),
...
{ label: 'Apparecchi', value: customerAssets.length, color: '#2F9E8E' },
{ label: 'Job aperti', value: openJobs.length, color: openJobs.length > 0 ? '#f59e0b' : '#22c55e' },
{ label: 'Verifiche di Sicurezza Elettrica', value: customerIec.length, color: '#9955ff' },
{ label: 'Verifiche funz.', value: customerFunc.length, color: '#1F7468' },
].map(k => (React.createElement("div", { key: k.label, style: { background: 'var(--surface)', border: '1px solid #2A2A38', borderTop: `3px solid ${k.color}`, borderRadius: 10, padding: '12px 18px', flex: 1, minWidth: 120 } },
...
React.createElement("div", { style: { background: 'var(--surface)', border: '1px dashed #2F9E8E44', borderRadius: 10, padding: '12px 16px', marginBottom: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 10 } },
React.createElement("div", null,
...
React.createElement("button", { onClick: () => alert('Funzione disponibile nella versione cloud — richiede integrazione email'), style: { background: 'var(--surface-2)', border: '1px solid #2F9E8E66', borderRadius: 6, color: '#2F9E8E', padding: '8px 16px', cursor: 'pointer', fontSize: 12, fontWeight: 700 } }, "+ Nuova richiesta")),
...
borderBottom: tab === t.id ? '2px solid #2F9E8E' : '2px solid transparent',
color: tab === t.id ? '#2F9E8E' : '#6A6A80',
padding: '8px 16px', cursor: 'pointer', fontSize: 12, fontWeight: 700,
marginBottom: -2, whiteSpace: 'nowrap', flexShrink: 0,
} }, t.label)))),
tab === 'jobs' && (React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 10 } }, customerJobs.length === 0 ? (React.createElement("div", { style: { textAlign: 'center', padding: 48, color: '#5A5A70', background: 'var(--surface)', borderRadius: 12, border: '1px solid #2A2A38' } }, "Nessun intervento registrato")) : customerJobs.slice().sort((a, b) => (b.openDate || '').localeCompare(a.openDate || '')).map(j => {
const asset = assets.find(a => a.id === j.assetId);
const hasReport = j.iecReportId || j.funcReportId;
return (React.createElement("div", { key: j.id, style: { background: 'var(--surface)', border: `1px solid ${j.status === 'chiuso' ? '#22c55e22' : j.status === 'aperto' ? '#ef444422' : (j.status || '').indexOf('attesa') >= 0 ? '#f59e0b33' : 'var(--border-4)'}`, borderRadius: 10, padding: '14px 16px' } },
...
React.createElement(Badge, { text: j.priority, color: j.priority === 'urgente' ? '#ef4444' : j.priority === 'alta' ? '#f97316' : 'var(--text-2)' }),
...
"Chiuso: ",
j.closeDate))),
j.timeline && j.timeline.length > 0 && (React.createElement("div", { style: { marginTop: 8, padding: '8px 12px', background: 'var(--bg)', borderRadius: 6, borderLeft: '3px solid #2F9E8E' } },
...
t.note))))),
j.attachments && j.attachments.length > 0 && (React.createElement("div", { style: { marginTop: 8, padding: '8px 12px', background: 'var(--bg)', borderRadius: 6, borderLeft: '3px solid #a855f7' } },
...
React.createElement("button", { onClick: () => downloadAttachment(att), style: { background: 'var(--surface-2)', border: '1px solid #2F9E8E44', borderRadius: 4, color: '#2F9E8E', padding: '2px 8px', cursor: 'pointer', fontSize: 10, fontWeight: 700 } }, "\u2B07 Scarica")));
}))),
hasReport && (React.createElement("div", { style: { marginTop: 8, fontSize: 11, color: '#2F9E8E' } }, "\u2713 Rapporto tecnico collegato (visibile nelle tab dedicate)"))));
}))),
tab === 'assets' && (React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 10 } }, customerAssets.length === 0 ? (React.createElement("div", { style: { textAlign: 'center', padding: 48, color: '#5A5A70', background: 'var(--surface)', borderRadius: 12, border: '1px solid #2A2A38' } }, "Nessun apparecchio registrato")) : customerAssets.map(a => (React.createElement("div", { key: a.id, style: { background: 'var(--surface)', border: '1px solid #2A2A38', borderRadius: 10, padding: '14px 16px' } },
React.createElement("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 10, flexWrap: 'wrap' } },
React.createElement("div", { style: { flex: 1 } },
...
a.nextService && (React.createElement("div", { style: { marginTop: 8, padding: '6px 10px', background: 'var(--bg)', borderRadius: 6, fontSize: 11, color: '#5A5A70', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 6 } },
...
tab === 'iec' && (React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 10 } }, customerIec.length === 0 ? (React.createElement("div", { style: { textAlign: 'center', padding: 48, color: '#5A5A70', background: 'var(--surface)', borderRadius: 12, border: '1px solid #2A2A38' } }, "Nessuna verifica di sicurezza elettrica")) : customerIec.slice().sort((a, b) => (b.date || '').localeCompare(a.date || '')).map(r => {
const asset = assets.find(a => a.id === r.assetId);
return (React.createElement("div", { key: r.id, style: { background: 'var(--surface)', border: `1px solid ${r.overallPass ? '#22c55e33' : '#ef444433'}`, borderRadius: 10, padding: '14px 16px' } },
React.createElement("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 8 } },
React.createElement("div", null,
...
r.attachments && r.attachments.length > 0 && (React.createElement("div", { style: { marginTop: 8, padding: '8px 12px', background: 'var(--bg)', borderRadius: 6, borderLeft: '3px solid #a855f7' } },
...
React.createElement("span", { style: { fontSize: 11, color: '#9090A8', flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' } }, att.name),
React.createElement("button", { onClick: () => downloadAttachment(att), style: { background: 'var(--surface-2)', border: '1px solid #2F9E8E44', borderRadius: 4, color: '#2F9E8E', padding: '2px 8px', cursor: 'pointer', fontSize: 10, fontWeight: 700 } }, "\u2B07")));
}))),
React.createElement("button", { onClick: () => generateIECPDF(r, asset, customer, company), style: { marginTop: 10, background: 'var(--surface-2)', border: '1px solid #2F9E8E44', borderRadius: 6, color: '#2F9E8E', padding: '5px 14px', cursor: 'pointer', fontSize: 11, fontWeight: 700 } }, "\u2B07 Scarica rapporto PDF")));
}))),
tab === 'func' && (React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 10 } }, customerFunc.length === 0 ? (React.createElement("div", { style: { textAlign: 'center', padding: 48, color: '#5A5A70', background: 'var(--surface)', borderRadius: 12, border: '1px solid #2A2A38' } }, "Nessuna verifica funzionale")) : customerFunc.slice().sort((a, b) => (b.date || '').localeCompare(a.date || '')).map(r => {
const asset = assets.find(a => a.id === r.assetId);
return (React.createElement("div", { key: r.id, style: { background: 'var(--surface)', border: `1px solid ${r.overallPass ? '#22c55e33' : '#ef444433'}`, borderRadius: 10, padding: '14px 16px' } },
React.createElement("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 8 } },
React.createElement("div", null,
...
React.createElement("button", { onClick: () => generateFuncPDF(r, asset, customer, company), style: { marginTop: 10, background: 'var(--surface-2)', border: '1px solid #2F9E8E44', borderRadius: 6, color: '#2F9E8E', padding: '5px 14px', cursor: 'pointer', fontSize: 11, fontWeight: 700 } }, "\u2B07 Scarica rapporto PDF")));
}))),
...
React.createElement("div", { style: { fontSize: 11, fontWeight: 800, color: "#2F9E8E", marginBottom: 8, textTransform: "uppercase", letterSpacing: .6 } },
"I tuoi template (",
custom.length,
")"),
custom.map(([id, t]) => {
...
" sezioni")),
React.createElement("div", { style: { display: "flex", gap: 6, flexShrink: 0 } },
React.createElement("button", { onClick: () => onEdit(t), style: { background: "var(--surface-2)", border: "1px solid var(--border)", borderRadius: 6, color: "#6FC2B5", padding: "6px 11px", cursor: "pointer", fontSize: 12, fontWeight: 700 } }, "Modifica"),
...
React.createElement("div", { style: { fontSize: 22, fontWeight: 900, color: color || "#2F9E8E", fontFamily: "monospace" } }, n),
...
? React.createElement("span", null,
React.createElement("strong", { style: { color: "#2F9E8E" } }, "Sticker apparecchio:"),
...
: (supaActive
? React.createElement("span", null,
React.createElement("strong", { style: { color: "#2F9E8E" } }, "QR online:"),
...
React.createElement("span", { style: { fontSize: 12.5, color: "var(--text-2)", fontWeight: 600 } }, "Larghezza nastro:"),
[24, 18, 12].map(wmm => (React.createElement("button", { key: wmm, type: "button", onClick: () => setTapeW(wmm), style: { background: tapeW === wmm ? "#2F9E8E22" : "var(--surface)", border: "1px solid " + (tapeW === wmm ? "#2F9E8E" : "var(--border)"), color: tapeW === wmm ? "#2F9E8E" : "var(--text-2)", borderRadius: 7, padding: "7px 12px", fontSize: 12, fontWeight: 700, cursor: "pointer", touchAction: "manipulation" } },
wmm,
" mm")))),
...
React.createElement("strong", { style: { color: "#6FC2B5" } }, " controlli s\u00EC/no"),
...
React.createElement("span", { style: { fontSize: 11, fontWeight: 800, color: "#2F9E8E", flexShrink: 0 } },
"SEZIONE ",
si + 1),
...
React.createElement("div", { style: { fontSize: 10, color: "#6FC2B5", fontWeight: 700, marginBottom: 6, textTransform: "uppercase", letterSpacing: .5 } }, "\u2713 Controlli s\u00EC / no"),
...
React.createElement("button", { onClick: () => addItem(si), style: Object.assign(Object.assign({}, MINI_BTN), { color: "#6FC2B5", borderColor: "#2F9E8E33" }) }, "+ Controllo s\u00EC/no"),
...
const STC = { nuova: "#2F9E8E", presa_in_carico: "#f59e0b", convertita: "#22c55e", chiusa: "var(--text-3)" };
...
r.contact),
React.createElement("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" } },
!done && React.createElement("button", { disabled: busy, onClick: () => doConvert(r), style: { background: busy ? "var(--border)" : "#2F9E8E", color: busy ? "var(--text-3)" : "var(--bg-deep)", border: "none", borderRadius: 8, padding: "9px 14px", fontSize: 13, fontWeight: 800, cursor: busy ? "default" : "pointer", touchAction: "manipulation" } }, busy ? "…" : "✓ Accetta e crea job"),
...
border-color: #2F9E8E !important;
box-shadow: 0 0 0 3px #2F9E8E22 !important;
}
...
const SECTION_ALIAS = { scadenze: "agenda", help: "procedures", ricognizione: "assets" };
...
{ id: "ricognizione", label: "Ricognizione", icon: "›" },
...
{ id: "richieste", label: "Richieste clienti", icon: "›", badge: (richieste.filter(r => r.status === "nuova").length) || null, bColor: "#2F9E8E" },
...
{ id: "invoices", label: "Preventivi", icon: "›", badge: stats.pendingInvoices > 0 ? stats.pendingInvoices : null, bColor: "#2F9E8E" },
]
},
{
...
React.createElement("stop", { offset: "0%", stopColor: "#2F9E8E" }),
...
background: active ? "#2F9E8E14" : "transparent",
...
active && React.createElement("span", { style: { position: "absolute", left: -8, top: 9, bottom: 9, width: 3, background: "#2F9E8E", borderRadius: "0 3px 3px 0" } }),
React.createElement("span", { style: { fontSize: 15, minWidth: 20, textAlign: "center", color: active ? "#2F9E8E" : "var(--text-3)" } }, n.icon),
...
active && React.createElement("span", { style: { position: "absolute", left: -8, top: 7, bottom: 7, width: 3, background: "#2F9E8E", borderRadius: "0 3px 3px 0" } }),
React.createElement("span", { style: { fontSize: 14, minWidth: 18, textAlign: "center", color: active ? "#2F9E8E" : "var(--text-3)" } }, n.icon),
React.createElement("span", { style: { flex: 1 } }, n.label),
n.badge && React.createElement("span", { style: { background: n.bColor, color: "#fff", borderRadius: 10, padding: "1px 7px", fontSize: 10, fontWeight: 700, letterSpacing: .3 } }, n.badge)));
}))))),
...
"v",
APP_VERSION),
React.createElement("button", { onClick: () => setModal({ type: "settings" }), onMouseEnter: e => e.currentTarget.style.color = "#2F9E8E", onMouseLeave: e => e.currentTarget.style.color = "var(--text-3)", style: { background: "none", border: "none", color: "var(--text-3)", fontSize: 14, cursor: "pointer", transition: "color .15s" } }, "\u2699 Impostazioni"))))),
...
isMobile && (ptrPull > 0 || ptrRefreshing) && (React.createElement("div", { style: { position: "fixed", top: 8, left: "50%", transform: `translateX(-50%) translateY(${Math.min(ptrPull, 50) - 50}px)`, zIndex: 500, background: "var(--bg)", border: "1px solid #2F9E8E66", borderRadius: 24, padding: "8px 16px", display: "flex", alignItems: "center", gap: 8, boxShadow: "0 4px 14px #000a", opacity: ptrRefreshing ? 1 : Math.min(ptrPull / 60, 1), transition: ptrRefreshing ? "none" : "transform .15s" } },
React.createElement("span", { style: { display: "inline-block", width: 14, height: 14, border: "2px solid var(--border-4)", borderTopColor: "#2F9E8E", borderRadius: "50%", animation: ptrRefreshing ? "ptr-spin .6s linear infinite" : "none", transform: ptrRefreshing ? "none" : `rotate(${ptrPull * 4}deg)` } }),
React.createElement("span", { style: { fontSize: 12, color: "#2F9E8E", fontWeight: 700 } }, ptrRefreshing ? "Aggiornamento…" : ptrPull > 60 ? "Rilascia per aggiornare" : "Tira per aggiornare"))),
...
React.createElement("button", { onClick: () => setNavOpen(true), style: { background: "none", border: "none", color: "var(--text)", fontSize: 22, cursor: "pointer", padding: "4px 8px", touchAction: "manipulation", WebkitTapHighlightColor: "transparent" } }, "\u2261"),
React.createElement("div", { style: { flex: 1, textAlign: "center", minWidth: 0 } },
company.name && React.createElement("div", { style: { fontSize: 9, color: "#2F9E8E", letterSpacing: 1.5, textTransform: "uppercase", marginBottom: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" } }, company.name),
...
React.createElement("div", { style: { width: 32, height: 32, borderRadius: "50%", background: "#2F9E8E22", border: "1px solid #2F9E8E55", color: "#6FC2B5", fontWeight: 900, fontSize: 15, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 } }, s.n),
React.createElement("div", { style: { flex: 1, minWidth: 0 } },
...
React.createElement("button", { onClick: s.go, style: { background: "#2F9E8E", color: "#0a0a0e", border: "none", borderRadius: 8, padding: "8px 14px", fontSize: 12.5, fontWeight: 800, cursor: "pointer", whiteSpace: "nowrap", flexShrink: 0 } }, s.btn)))),
...
React.createElement(Pill, { label: "Apparecchi", value: stats.totalAssets, color: "#2F9E8E", onClick: () => setTab("assets") }),
React.createElement(Pill, { label: "Job aperti", value: stats.openJobs, color: "#2F9E8E", sub: stats.urgentJobs > 0 ? stats.urgentJobs + " urgenti" : "", onClick: () => setTab("jobs") }),
...
React.createElement(Pill, { label: "Clienti", value: stats.customers, color: "#2F9E8E", onClick: () => setTab("customers") }))),
(() => {
...
React.createElement("span", { style: { fontSize: 11, color: "var(--text-3)", fontFamily: "monospace" } }, totalTodo === 0 ? "tutto in ordine" : totalTodo + " attività")),
...
React.createElement("span", { style: { fontSize: 11, color: "var(--text-3)", fontFamily: "monospace" } },
...
"Job urgente \u00B7 ",
j.id),
React.createElement("span", { style: { fontSize: 10, color: "var(--text-3)", fontFamily: "monospace" } }, j.openDate)),
...
return (React.createElement("div", { key: a.id, onClick: () => setModal({ type: "assetDetail", data: a }), style: { padding: "10px 14px", background: "var(--surface)", border: "1px solid #ef444433", borderRadius: 8, cursor: "pointer", touchAction: "manipulation", WebkitTapHighlightColor: "transparent" } },
React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 } },
React.createElement("span", { style: { fontSize: 10, color: "#ef4444", fontWeight: 800, letterSpacing: .5, textTransform: "uppercase" } },
"Manut. scaduta da ",
days,
"gg"),
React.createElement("span", { style: { fontSize: 10, color: "var(--text-3)", fontFamily: "monospace" } }, a.nextService)),
...
React.createElement("span", { onClick: () => setTab("agenda"), style: { fontSize: 11, color: "#2F9E8E", cursor: "pointer", fontWeight: 600 } }, "vedi agenda \u203A")),
...
return (React.createElement("div", { key: a.id, onClick: () => setModal({ type: "assetDetail", data: a }), style: { padding: "8px 14px", background: "var(--bg)", borderRadius: 6, cursor: "pointer", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10, touchAction: "manipulation", WebkitTapHighlightColor: "transparent" } },
React.createElement("div", { style: { minWidth: 0, flex: 1 } },
...
React.createElement("div", { style: { fontSize: 9, color: "var(--text-4)", fontFamily: "monospace" } }, a.nextService))));
})))),
...
React.createElement("strong", { style: { color: "var(--text)", fontFamily: "monospace" } }, stats.operative),
" operativi"),
React.createElement("span", { onClick: () => setTab("assets"), style: { cursor: "pointer" } },
React.createElement("strong", { style: { color: "var(--text-2)", fontFamily: "monospace" } }, stats.maintenance),
" in manut."),
React.createElement("span", { onClick: () => setTab("assets"), style: { cursor: "pointer" } },
React.createElement("strong", { style: { color: stats.outOfService > 0 ? "#ef4444" : "var(--text-2)", fontFamily: "monospace" } }, stats.outOfService),
" fuori serv."),
...
React.createElement("strong", { style: { color: "var(--text-2)", fontFamily: "monospace" } }, stats.pendingInvoices),
" preventivi aperti"))));
})())),
...
React.createElement("div", { style: { marginBottom: 12 } },
React.createElement("div", { style: { fontSize: 17, fontWeight: 800, color: "var(--text)" } }, "Ricognizione reparto"),
...
React.createElement("button", { onClick: reconSimulate, style: { background: "transparent", border: "1px solid var(--border)", borderRadius: 6, color: "#2F9E8E", padding: "3px 8px", fontSize: 10.5, cursor: "pointer", fontWeight: 700 } }, "Simula scansione")),
...
React.createElement("button", { onClick: reconScan, style: { flex: 1, background: "#2F9E8E", border: "none", borderRadius: 8, color: "#04201c", padding: "10px", fontSize: 14, fontWeight: 800, cursor: "pointer" } }, "Scansiona"),
...
React.createElement("span", { style: { fontSize: 12, color: "#2F9E8E", fontWeight: 700 } }, reconResult.found.length + " trovati"),
...
React.createElement("div", { style: { fontSize: 11, color: "var(--text-2)", fontFamily: "monospace", wordBreak: "break-all" } }, reconResult.unknown.join("  ")),
...
React.createElement("span", { style: { fontSize: 12, color: "#2F9E8E", fontWeight: 700 } }, r.count)))),
...
" fuori servizio")),
React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" } },
isMobile && assets.length > 0 && (React.createElement("button", { onClick: toggleAssetView, style: { background: "var(--card)", border: "1px solid #2F9E8E44", borderRadius: 8, padding: "6px 12px", color: "#6FC2B5", fontSize: 12, fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", gap: 6 } }, assetMobileView === "table" ? "▦ Schede" : "▤ Tabella")),
...
if (compactView) {
return (React.createElement("div", { key: a.id, onClick: () => setModal({ type: "assetDetail", data: a }), style: { display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", borderBottom: "1px solid var(--border-2)", cursor: "pointer", background: "var(--surface)" } },
...
React.createElement("span", { style: { color: "#6FC2B5", fontSize: 13, fontWeight: 700, fontFamily: "monospace", flexShrink: 0 } }, a.assetCode || a.id),
...
React.createElement("div", { onClick: () => setModal({ type: "assetDetail", data: a }), style: { padding: "12px 14px 10px", cursor: "pointer", touchAction: "manipulation", WebkitTapHighlightColor: "transparent", borderBottom: "1px solid var(--border-2)" } },
...
React.createElement("strong", { style: { color: "#6FC2B5", fontSize: 16, fontFamily: "monospace", letterSpacing: .5, lineHeight: 1.2 } }, a.assetCode || a.id),
a.serial && React.createElement("span", { style: { fontSize: 11.5, color: "var(--text-2)", fontFamily: "monospace" } },
"S/N ",
a.serial)),
...
{ key: "assetCode", label: "Codice", render: v => React.createElement("strong", { style: { color: "#6FC2B5", fontFamily: "monospace" } }, v || "—") },
...
React.createElement("button", { onClick: () => setModal({ type: "assetDetail", data: assets.find(a => a.id === row.id) }), title: "Scheda apparecchio", style: { background: "var(--surface-3)", border: "1px solid var(--border)", borderRadius: 5, color: "var(--text-2)", padding: "3px 8px", cursor: "pointer", fontSize: 11 } }, "\uD83D\uDCCB"),
React.createElement("button", { onClick: () => setModal({ type: "iec", assetId: row.id, data: null }), title: "Verifica di Sicurezza Elettrica", style: { background: "var(--surface-3)", border: "1px solid var(--border)", borderRadius: 5, color: "#6FC2B5", padding: "3px 8px", cursor: "pointer", fontSize: 11 } }, "\u26A1"),
...
{ id: "open", label: "Aperti", count: jobs.filter(j => j.status !== "chiuso").length, color: "#2F9E8E" },
...
"\uD83C\uDFE2 ",
c.name),
React.createElement("div", { style: { fontSize: 10, color: "var(--text-3)", fontFamily: "monospace" } },
"Aperto: ",
j.openDate,
...
React.createElement("button", { onClick: () => setTab("parts"), style: { background: tab === "parts" ? "#2F9E8E18" : "transparent", color: tab === "parts" ? "#2F9E8E" : "var(--text-2)", border: "none", borderBottom: tab === "parts" ? "2px solid #2F9E8E" : "2px solid transparent", padding: "8px 14px", cursor: "pointer", fontSize: 13, fontWeight: 700, marginBottom: -1, touchAction: "manipulation" } },
" Stock parti",
stats.lowStock > 0 ? ` (${stats.lowStock}⚠)` : ""),
React.createElement("button", { onClick: () => setTab("withdrawals"), style: { background: tab === "withdrawals" ? "#2F9E8E18" : "transparent", color: tab === "withdrawals" ? "#2F9E8E" : "var(--text-2)", border: "none", borderBottom: tab === "withdrawals" ? "2px solid #2F9E8E" : "2px solid transparent", padding: "8px 14px", cursor: "pointer", fontSize: 13, fontWeight: 700, marginBottom: -1, touchAction: "manipulation" } },
" Scarichi (",
withdrawals.length,
")"),
React.createElement("button", { onClick: () => setTab("orders"), style: { background: tab === "orders" ? "#2F9E8E18" : "transparent", color: tab === "orders" ? "#2F9E8E" : "var(--text-2)", border: "none", borderBottom: tab === "orders" ? "2px solid #2F9E8E" : "2px solid transparent", padding: "8px 14px", cursor: "pointer", fontSize: 13, fontWeight: 700, marginBottom: -1, touchAction: "manipulation" } },
" Ordini (",
orders.length,
")")))),
...
p.code && React.createElement("div", { style: { fontSize: 11, color: "var(--text-2)", fontFamily: "monospace", marginBottom: 3 } }, p.code),
...
React.createElement("span", { style: { color: "var(--text-3)" } },
"Min: ",
React.createElement("span", { style: { color: "var(--text-2)", fontFamily: "monospace" } }, p.minQty)),
React.createElement("span", { style: { color: "var(--text-3)" } },
"Acquisto: ",
React.createElement("span", { style: { color: "var(--text-2)", fontFamily: "monospace" } },
"\u20AC",
...
nApp > 0 && React.createElement("span", { style: { padding: "2px 8px", background: "#2F9E8E22", color: "#2F9E8E", borderRadius: 5, fontSize: 11, fontWeight: 700, whiteSpace: "nowrap" } },
nApp,
" app.")),
...
" ",
c.email),
c.phone && React.createElement("div", { style: { fontSize: 11, color: "var(--text-2)", marginBottom: 3, fontFamily: "monospace" } },
" ",
c.phone),
c.vat && React.createElement("div", { style: { fontSize: 10, color: "var(--text-3)", fontFamily: "monospace", marginTop: 4 } },
"P.IVA: ",
c.vat),
...
React.createElement("button", { onClick: (e) => { e.stopPropagation(); setModal({ type: "clientReport", data: c }); }, title: "Report parco macchine", style: { background: "transparent", color: "#6FC2B5", border: "none", borderRight: "1px solid var(--border-2)", padding: "10px 0", cursor: "pointer", fontSize: 14 } }, "\uD83D\uDCCB"),
...
{ key: "nApparecchi", label: "Apparecchi", render: v => React.createElement("span", { style: { color: "#2F9E8E", fontWeight: 700 } }, v) },
...
React.createElement("button", { onClick: () => setModal({ type: "clientReport", data: customers.find(c => c.id === row.id) }), title: "Report parco macchine", style: { background: "#2F9E8E15", border: "1px solid #2F9E8E33", borderRadius: 5, color: "#6FC2B5", padding: "3px 7px", cursor: "pointer", fontSize: 11, fontWeight: 700, marginRight: 2 } }, "\uD83D\uDCCB"),
...
React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 8, marginBottom: 6 } },
React.createElement("strong", { style: { color: "var(--text)", fontSize: 14, fontFamily: "monospace", flex: 1, minWidth: 0, wordBreak: "break-word" } }, i.number),
...
"\uD83C\uDFE2 ",
c.name),
React.createElement("div", { style: { fontSize: 11, color: "var(--text-3)", fontFamily: "monospace" } },
"Data: ",
i.date,
...
{ key: "number", label: "N. Preventivo", render: v => React.createElement("span", { style: { fontFamily: "monospace", fontWeight: 700, color: "var(--text)" } }, v) },
...
"\u20AC",
v) },
{ key: "iva", label: "IVA", render: v => React.createElement("span", { style: { fontFamily: "monospace", color: "var(--text-3)" } },
"\u20AC",
v) },
...
React.createElement("span", { style: { fontSize: 12, color: "var(--text-3)", fontFamily: "monospace" } }, inv.number),
...
React.createElement("strong", { style: { color: "var(--text)", fontSize: 14, fontFamily: "monospace", flex: 1, minWidth: 0, wordBreak: "break-word" } }, r.reportNumber || r.id),
...
React.createElement("span", { style: { padding: "2px 6px", color: "var(--text-3)", fontFamily: "monospace" } }, r.date)),
...
React.createElement("span", { style: { fontSize: 11, fontWeight: 800, color: r.published ? "var(--text-3)" : "#2F9E8E" } }, r.published ? "Ritira" : "📤 Pubblica")),
...
{ key: "jobId", label: "Intervento", render: v => v ? React.createElement("span", { title: "Questa verifica \u00E8 registrata anche come intervento nello storico/agenda", style: { fontSize: 11, color: "#6FC2B5", background: "#2F9E8E15", border: "1px solid #2F9E8E33", borderRadius: 5, padding: "2px 8px", fontWeight: 700, whiteSpace: "nowrap" } }, "\u2713 in agenda") : React.createElement("span", { style: { color: "var(--text-4)" } }, "\u2014") },
...
React.createElement("button", { onClick: () => generateFuncPDF(rep, a, c, company, allTemplates), title: "PDF", style: { background: "#2F9E8E15", border: "1px solid #2563eb33", borderRadius: 5, color: "#6FC2B5", padding: "3px 8px", cursor: "pointer", fontSize: 11 } }, " PDF")));
} })))),
...
React.createElement("div", { style: { flex: 1, minWidth: 0 } },
React.createElement("div", { style: { color: "var(--text)", fontSize: 13, fontWeight: 600, fontFamily: "monospace", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, r.reportNumber || r.id),
...
React.createElement("button", { onClick: () => generateIECPDF(rep, a, c, company), title: "PDF", style: { background: "#2F9E8E15", border: "1px solid #2563eb33", borderRadius: 5, color: "#6FC2B5", padding: "3px 8px", cursor: "pointer", fontSize: 11 } }, " PDF")));
} })))),
...
React.createElement("p", { style: { color: "var(--text-3)", margin: "2px 0 0", fontSize: 12, fontFamily: "monospace" } }, "Attivit\u00E0 programmate per anno \u2014 basato su nextService degli apparecchi")),
React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" } },
...
{ key: "status", label: "Stato", opts: ["operativo", "in manutenzione", "fuori servizio"], render: v => React.createElement(Badge, { text: v, color: STATUS_COLOR[v] || "var(--text-3)" }) },
], rows: items, actions: row => (React.createElement("button", { onClick: () => setModal({ type: "iec", data: null, assetId: row.assetId }), style: { background: "#2F9E8E15", border: "1px solid #2563eb33", borderRadius: 5, color: "#6FC2B5", padding: "3px 8px", cursor: "pointer", fontSize: 11, whiteSpace: "nowrap" } }, "Verifica")) })))))),
...
(modal === null || modal === void 0 ? void 0 : modal.type) === "settings" && React.createElement(SettingsModal, { isAdmin: isAdmin, isSuperuser: isSuperuser, onImportRfidScan: importRfidScan, data: { assets, parts, jobs, orders, withdrawals, customers, invoices, quotes, instruments, procedures, iecReports, funcReports, company, customTemplates, cestino, _meta: { version: "3.6", exportedAt: new Date().toISOString(), app: "MedTrace" } }, company: company, onUpdateCompany: setCompany, onImport: handleImport, onMerge: handleMerge, onReset: handleReset, onCloudPull: handleCloudPull, onReplaceJobs: (nj) => setJobs(nj), onClose: popModal, onOpenCestino: () => pushModal({ type: "cestino" }) }),
...
React.createElement("div", { style: { fontSize: 11, color: "var(--text-3)", marginTop: 2, fontFamily: "monospace" } }, csvModal.filename)),
...
}, style: { background: "#2F9E8E", color: "#fff", border: "none", borderRadius: 7, padding: "8px 16px", cursor: "pointer", fontSize: 13, fontWeight: 700 } }, "Copia negli appunti"),
React.createElement("button", { onClick: () => {
const text = csvModal.isJson ? csvModal.data : ("\uFEFF" + csvModal.data);
...
}, style: { background: "#2F9E8E", color: "#000", border: "none", borderRadius: 7, padding: "8px 16px", cursor: "pointer", fontSize: 13, fontWeight: 800, display: "inline-flex", alignItems: "center", gap: 6, touchAction: "manipulation" } }, "\uD83D\uDDA8 Salva PDF"),
...
const confirmBg = isPositive ? '#2F9E8E' : '#dc2626';
...
React.createElement("button", { onClick: () => answer(true), style: { background: '#2F9E8E',
...
React.createElement("div", { style: { width: 32, height: 32, border: '3px solid #2A2A38', borderTopColor: '#2F9E8E', borderRadius: '50%', animation: 'spin 1s linear infinite' } }),
...
React.createElement("div", { style: { fontSize: 30, fontWeight: 900, color: '#2F9E8E', marginBottom: 8 } }, "MedTrace"),
...
React.createElement("button", { onClick: () => window.location.reload(), style: { background: '#2F9E8E', color: '#06251f', border: 'none', borderRadius: 9, padding: '11px 22px', fontWeight: 800, fontSize: 14, cursor: 'pointer' } }, "Riprova"))));
if (!currentUser)
