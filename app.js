...
f.norm === "62353" && (React.createElement("div", { style: { background: "var(--bg)", border: "1px solid #2F9E8E44", borderRadius: 8, padding: "10px 14px", fontSize: 11, color: "var(--text-2)", lineHeight: 1.5 } },
...
" \u22652 M\u03A9"))),
f.norm === "60601" && (React.createElement("div", { style: { background: "var(--bg)", border: "1px solid #2F9E8E44", borderRadius: 8, padding: "10px 14px", fontSize: 11, color: "var(--text-2)", lineHeight: 1.5 } },
...
const TD_S = { padding: "7px 10px", borderBottom: "1px solid var(--border-2)", borderRight: "1px solid var(--border-2)", fontSize: 12, color: "var(--text)", whiteSpace: "nowrap", maxWidth: 200, overflow: "hidden", textOverflow: "ellipsis", verticalAlign: "middle" };
...
React.createElement("div", { style: { fontSize: 11, color: copied ? '#2F9E8E' : 'var(--text-3)', marginBottom: 22 } }, copied ? '✓ Copiato negli appunti' : 'Tocca per copiare · Conservalo: serve ai colleghi per registrarsi'),
...
React.createElement("h2", { style: { color: 'var(--text-bright)', fontSize: 18, marginBottom: 8 } }, "Nessun cliente"),
React.createElement("p", { style: { color: 'var(--text-3)', fontSize: 13, marginBottom: 20 } }, "Per provare la modalit\u00E0 portale cliente, prima crea almeno un cliente nella sezione Clienti."),
...
React.createElement("span", { style: { color: 'var(--text-3)', fontSize: 12, fontWeight: 700 } }, "Anteprima come cliente:"),
React.createElement("select", { value: selectedCustomerId, onChange: e => setSelectedCustomerId(e.target.value), style: { background: 'var(--bg)', border: '1px solid #2A2A38', borderRadius: 6, padding: '5px 12px', color: 'var(--text-bright)', fontSize: 13, fontWeight: 700 } }, customers.map(c => React.createElement("option", { key: c.id, value: c.id }, c.name))),
React.createElement("span", { style: { marginLeft: 'auto', color: 'var(--text-4)', fontSize: 10 } },
...
React.createElement("div", { style: { flex: 1, minWidth: 0 } },
React.createElement("div", { style: { fontSize: 18, fontWeight: 900, color: 'var(--text-bright)', marginBottom: 2 } },
"Portale ",
...
React.createElement("div", { style: { fontSize: 10, color: 'var(--text-3)', marginTop: 4, textTransform: 'uppercase', letterSpacing: .7, fontWeight: 600 } }, k.label))))),
...
React.createElement("div", null,
React.createElement("div", { style: { fontSize: 13, fontWeight: 700, color: 'var(--text-bright)' } }, "Richiedi intervento"),
React.createElement("div", { style: { fontSize: 11, color: 'var(--text-3)' } }, "Segnala un guasto o richiedi una verifica programmata")),
...
tab === 'jobs' && (React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 10 } }, customerJobs.length === 0 ? (React.createElement("div", { style: { textAlign: 'center', padding: 48, color: 'var(--text-3)', background: 'var(--surface)', borderRadius: 12, border: '1px solid #2A2A38' } }, "Nessun intervento registrato")) : customerJobs.slice().sort((a, b) => (b.openDate || '').localeCompare(a.openDate || '')).map(j => {
const asset = assets.find(a => a.id === j.assetId);
...
React.createElement("span", { style: { fontFamily: 'monospace', fontSize: 11, color: 'var(--text-3)' } }, j.id),
...
React.createElement("span", { style: { fontSize: 11, color: 'var(--text-3)', textTransform: 'capitalize' } }, j.type)),
React.createElement("div", { style: { fontSize: 13, color: 'var(--text-bright)', fontWeight: 600, marginBottom: 3 } }, j.description || '—'),
asset && (React.createElement("div", { style: { fontSize: 11, color: 'var(--text-3)' } },
"\uD83D\uDCE6 ",
asset.name,
asset.brand ? ` · ${asset.brand}` : '',
asset.serial ? ` · S/N: ${asset.serial}` : ''))),
React.createElement("div", { style: { textAlign: 'right', flexShrink: 0 } },
React.createElement("div", { style: { fontSize: 11, color: 'var(--text-3)' } }, j.openDate),
...
React.createElement("div", { style: { fontSize: 10, color: 'var(--text-3)', fontWeight: 700, marginBottom: 4, textTransform: 'uppercase', letterSpacing: .5 } },
"Timeline (",
j.timeline.length,
" step)"),
j.timeline.slice(-3).map((t, i) => (React.createElement("div", { key: i, style: { fontSize: 11, color: 'var(--text-2)', marginBottom: 2 } },
React.createElement("span", { style: { color: 'var(--text-3)', fontFamily: 'monospace', marginRight: 6 } }, t.date),
t.note))))),
...
React.createElement("div", { style: { fontSize: 10, color: 'var(--text-3)', fontWeight: 700, marginBottom: 5, textTransform: 'uppercase', letterSpacing: .5 } },
"Documenti allegati (",
...
React.createElement("span", { style: { fontSize: 11, color: 'var(--text-2)', flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' } }, att.name),
...
tab === 'assets' && (React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 10 } }, customerAssets.length === 0 ? (React.createElement("div", { style: { textAlign: 'center', padding: 48, color: 'var(--text-3)', background: 'var(--surface)', borderRadius: 12, border: '1px solid #2A2A38' } }, "Nessun apparecchio registrato")) : customerAssets.map(a => (React.createElement("div", { key: a.id, style: { background: 'var(--surface)', border: '1px solid #2A2A38', borderRadius: 10, padding: '14px 16px' } },
React.createElement("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 10, flexWrap: 'wrap' } },
React.createElement("div", { style: { flex: 1 } },
React.createElement("div", { style: { fontSize: 14, fontWeight: 700, color: 'var(--text-bright)', marginBottom: 4 } }, a.name),
React.createElement("div", { style: { fontSize: 11, color: 'var(--text-3)' } }, [a.brand, a.model, a.serial && `S/N: ${a.serial}`, a.location].filter(Boolean).join(' · ')),
a.riskClass && (React.createElement("div", { style: { fontSize: 10, color: 'var(--text-3)', marginTop: 4 } },
"Classe rischio: ",
React.createElement("span", { style: { color: 'var(--text-2)' } }, a.riskClass)))),
React.createElement(Badge, { text: a.status, color: STATUS_COLOR_PORTAL[a.status] })),
a.nextService && (React.createElement("div", { style: { marginTop: 8, padding: '6px 10px', background: 'var(--bg)', borderRadius: 6, fontSize: 11, color: 'var(--text-3)', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 6 } },
React.createElement("span", null, "Prossima manutenzione:"),
React.createElement("span", { style: { color: 'var(--text-bright)', fontWeight: 700 } }, a.nextService)))))))),
tab === 'iec' && (React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 10 } }, customerIec.length === 0 ? (React.createElement("div", { style: { textAlign: 'center', padding: 48, color: 'var(--text-3)', background: 'var(--surface)', borderRadius: 12, border: '1px solid #2A2A38' } }, "Nessuna verifica di sicurezza elettrica")) : customerIec.slice().sort((a, b) => (b.date || '').localeCompare(a.date || '')).map(r => {
...
React.createElement("span", { style: { fontFamily: 'monospace', fontWeight: 700, color: 'var(--text-bright)' } }, r.reportNumber || r.id),
React.createElement("span", { style: { fontSize: 10, color: 'var(--text-3)' } },
r.norm,
" \u00B7 Cl.",
r.equipClass,
...
React.createElement("div", { style: { fontSize: 10, color: 'var(--text-3)', fontWeight: 700, marginBottom: 5, textTransform: 'uppercase' } }, "Documenti"),
...
tab === 'func' && (React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 10 } }, customerFunc.length === 0 ? (React.createElement("div", { style: { textAlign: 'center', padding: 48, color: 'var(--text-3)', background: 'var(--surface)', borderRadius: 12, border: '1px solid #2A2A38' } }, "Nessuna verifica funzionale")) : customerFunc.slice().sort((a, b) => (b.date || '').localeCompare(a.date || '')).map(r => {
const asset = assets.find(a => a.id === r.assetId);
return (React.createElement("div", { key: r.id, style: { background: 'var(--surface)', border: `1px solid ${r.overallPass ? '#22c55e33' : '#ef444433'}`, borderRadius: 10, padding: '14px 16px' } },
React.createElement("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 8 } },
React.createElement("div", null,
...
React.createElement("div", { style: { textAlign: 'center', marginTop: 32, padding: '16px 0', fontSize: 11, color: 'var(--text-4)', borderTop: '1px solid #1a1a22' } },
...
React.createElement("div", { style: { fontSize: 15, fontWeight: 900, color: "var(--text-bright)", textTransform: "uppercase", letterSpacing: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" } }, ((_a = NAV.find(n => n.id === tab)) === null || _a === void 0 ? void 0 : _a.label) || "MedTrace")),
