...
React.createElement("div", { style: { fontSize: 13, color: "#fca5a5", maxWidth: 540, wordBreak: "break-word", fontFamily: "monospace", background: "#1a1014", border: "1px solid #f8717155", borderRadius: 8, padding: "10px 12px" } }, msg),
...
const FORM_BTN_GHOST = { background: "#1a1a22", border: "1px solid var(--border)", borderRadius: 9, color: "var(--text-2)", padding: "11px 20px", cursor: "pointer", fontWeight: 700, fontSize: 14 };
...
const Dot = ({ x, y, c }) => React.createElement("circle", { cx: x, cy: y, r: 5, fill: c, stroke: "var(--bg-deep)", strokeWidth: 1 });
...
m.editableLimit ? (React.createElement("input", { type: "text", disabled: m.na, value: m.limit, onChange: e => setF(x => (Object.assign(Object.assign({}, x), { measures: x.measures.map(mm => mm.id === m.id ? Object.assign(Object.assign({}, mm), { limit: e.target.value, limitVal: parseFloat(String(e.target.value).replace(/[^0-9.]/g, "")) || mm.limitVal }) : mm) }))), title: "Limite modificabile", style: { background: "#1a1f2e", border: "1px solid #2F9E8E44", borderRadius: 5, padding: "4px 6px", color: "#6FC2B5", fontSize: 11, fontFamily: "monospace", width: "100%", outline: "none" } })) : (React.createElement("span", { style: { fontSize: 11, color: "var(--text-3)", fontFamily: "monospace" } }, m.limit)),
...
return (React.createElement("div", { key: m.id + "-tut", style: { background: "#11161F", border: "1px solid #2F9E8E", borderRadius: 10, padding: "14px 16px", marginBottom: 10, marginTop: 4, boxShadow: "0 4px 14px rgba(0,0,0,.4)" } },
...
return (React.createElement("div", { key: s.assetId + s.tipoKind + i, style: { background: "var(--surface)", borderTop: "1px solid #1a1a24", borderLeft: "3px solid " + col, padding: "10px 13px", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10 } },
...
const TH_S = { background: "var(--bg-2)", color: "var(--text-3)", padding: "8px 10px", textAlign: "left", fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: .7, borderBottom: "2px solid var(--border-2)", borderRight: "1px solid #141e2e", whiteSpace: "nowrap", cursor: "pointer", userSelect: "none", position: "sticky", top: 0, zIndex: 2 };
...
React.createElement("div", { style: { overflowX: isMobile ? "auto" : "visible", overflowY: "auto", border: "1px solid var(--border-2)", borderRadius: "0 0 10px 10px", background: "#111116", maxHeight: "68vh" } },
...
React.createElement("div", { style: { background: "#16161D", border: "1px solid var(--border)", borderRadius: 16, width: wide ? "min(820px,97vw)" : "min(620px,97vw)", maxHeight: "93vh", overflowY: "auto", padding: 0, boxSizing: "border-box", animation: "mtFadeIn .2s ease", boxShadow: "0 20px 60px rgba(0,0,0,0.5)" }, onClick: e => e.stopPropagation() },
React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "18px 24px", borderBottom: "1px solid var(--border-2)", position: "sticky", top: 0, background: "#16161D", zIndex: 5, borderRadius: "16px 16px 0 0" } },
...
const card = { background: "var(--card)", border: "1px solid #1e293b", borderRadius: 14, padding: "14px 16px" };
...
const selS = { background: "#0F141A", color: "var(--text)", border: "1px solid #1e293b", borderRadius: 8, padding: "8px 10px", fontSize: 13 };
...
const selStyle = { width: "100%", background: "#0F141A", color: "var(--text)", border: "1px solid #1e293b", borderRadius: 8, padding: "8px 10px", fontSize: 13 };
...
rep.crit.slice(0, 15).map((c, i) => React.createElement("div", { key: i, style: { display: "flex", justifyContent: "space-between", gap: 8, padding: "3px 0", borderBottom: "1px solid #1a2030" } },
...
return (React.createElement("div", { style: { background: "var(--card)", border: "1px solid #1e293b", borderRadius: 14, padding: "14px 16px", marginTop: 12 } },
...
catch (e) { } }, style: { background: '#0D0D12', border: '1px dashed #2F9E8E66', borderRadius: 10, padding: '14px 10px', fontFamily: 'monospace', fontSize: 20, fontWeight: 800, letterSpacing: 2, color: '#2F9E8E', cursor: 'pointer', marginBottom: 8, wordBreak: 'break-all' } }, createdCode),
...
React.createElement("button", { onClick: () => downloadAttachment(att), title: "Scarica", style: { background: '#202028', border: '1px solid #2F9E8E44', borderRadius: 4, color: '#2F9E8E', padding: '3px 8px', cursor: 'pointer', fontSize: 10, fontWeight: 700 } }, "\u2B07"),
...
background: '#1E1E28', border: '1px dashed #2F9E8E44', borderRadius: 6, padding: '6px 14px',
...
React.createElement("div", { style: { display: 'flex', gap: 6, flexShrink: 0 } },
React.createElement("button", { onClick: onEdit, style: { background: '#1E1E28', border: '1px solid #2F9E8E44', borderRadius: 6, color: '#2F9E8E', padding: '6px 12px', cursor: 'pointer', fontSize: 11, fontWeight: 700 } }, "\u270F Modifica"),
...
step.expectedValue && (React.createElement("div", { style: { background: '#0D0D12', border: '1px solid #2F9E8E33', borderRadius: 6, padding: '6px 12px', marginTop: 6, fontSize: 12 } },
...
proc.notes && (React.createElement("div", { style: { background: '#141418', border: '1px solid #2A2A38', borderRadius: 10, padding: '14px 18px', marginBottom: 14, borderLeft: '4px solid #2F9E8E' } },
...
React.createElement("button", { type: "button", onClick: () => updStep(i, 'image', ''), style: { background: '#1E1E28', border: '1px solid #ef444433', borderRadius: 4, color: '#ef4444', padding: '3px 10px', cursor: 'pointer', fontSize: 11, fontWeight: 700 } }, "Rimuovi"))) : (React.createElement("label", { style: { display: 'inline-flex', alignItems: 'center', gap: 6, cursor: 'pointer', background: '#141418', border: '1px dashed #2F9E8E44', borderRadius: 6, padding: '5px 12px', color: '#2F9E8E', fontSize: 11, fontWeight: 700 } },
...
f.laborLines.length,
" voci)"),
React.createElement("button", { onClick: addLabor, style: { background: '#1E1E28', border: '1px solid #2F9E8E44', borderRadius: 6, color: '#2F9E8E', padding: '4px 12px', cursor: 'pointer', fontSize: 11, fontWeight: 700 } }, "+ Voce")),
...
React.createElement("button", { onClick: () => generateQuotePDF(q, customer, company, assets, jobs), style: { background: '#141418', border: '1px solid #2F9E8E44', borderRadius: 6, color: '#2F9E8E', padding: '4px 10px', cursor: 'pointer', fontSize: 11, fontWeight: 700 } }, "PDF"),
...
background: filterType === f.id ? '#2F9E8E22' : '#141418',
color: filterType === f.id ? '#2F9E8E' : '#64748b',
border: '1px solid ' + (filterType === f.id ? '#2F9E8E66' : '#2a3040'),
...
cells.push(React.createElement("div", { key: day, style: { minHeight: 64, padding: '5px', borderRight: '1px solid #14182a', borderBottom: '1px solid #14182a', background: isToday ? '#2F9E8E0a' : 'transparent' } },
React.createElement("div", { style: { fontSize: 11, fontWeight: isToday ? 900 : 500, color: isToday ? '#2F9E8E' : '#64748b', marginBottom: 4 } }, day),
...
return (React.createElement("div", { style: {
background: isSelected ? '#2F9E8E15' : '#0D0D12',
border: `1px solid ${isSelected ? '#2F9E8E66' : '#2A2A38'}`,
...
unplanned.length,
" non pianificati"))),
React.createElement("div", { style: { background: '#141418', border: `1px solid ${selectedIds.length > 0 ? '#2F9E8E44' : '#2A2A38'}`, borderRadius: 10, padding: '10px 14px', marginBottom: 14,
...
return (React.createElement("div", { key: month, style: { background: '#141418', border: `1px solid ${items.length > 0 ? '#2F9E8E33' : '#2A2A38'}`, borderRadius: 10, overflow: 'hidden' } },
React.createElement("div", { style: { padding: '8px 12px', background: items.length > 0 ? '#2F9E8E15' : '#1a1a22',
borderBottom: `1px solid ${items.length > 0 ? '#2F9E8E33' : '#2A2A38'}`,
...
React.createElement("div", { style: { background: '#141418', border: '1px dashed #2F9E8E44', borderRadius: 10, padding: '12px 16px', marginBottom: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 10 } },
React.createElement("div", null,
...
React.createElement("button", { onClick: () => alert('Funzione disponibile nella versione cloud — richiede integrazione email'), style: { background: '#1E1E28', border: '1px solid #2F9E8E66', borderRadius: 6, color: '#2F9E8E', padding: '8px 16px', cursor: 'pointer', fontSize: 12, fontWeight: 700 } }, "+ Nuova richiesta")),
...
"Chiuso: ",
j.closeDate))),
j.timeline && j.timeline.length > 0 && (React.createElement("div", { style: { marginTop: 8, padding: '8px 12px', background: '#0D0D12', borderRadius: 6, borderLeft: '3px solid #2F9E8E' } },
...
React.createElement("button", { onClick: () => downloadAttachment(att), style: { background: '#1E1E28', border: '1px solid #2F9E8E44', borderRadius: 4, color: '#2F9E8E', padding: '2px 8px', cursor: 'pointer', fontSize: 10, fontWeight: 700 } }, "\u2B07 Scarica")));
}))),
...
React.createElement("span", { style: { fontSize: 11, color: '#9090A8', flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' } }, att.name),
React.createElement("button", { onClick: () => downloadAttachment(att), style: { background: '#1E1E28', border: '1px solid #2F9E8E44', borderRadius: 4, color: '#2F9E8E', padding: '2px 8px', cursor: 'pointer', fontSize: 10, fontWeight: 700 } }, "\u2B07")));
}))),
React.createElement("button", { onClick: () => generateIECPDF(r, asset, customer, company), style: { marginTop: 10, background: '#1E1E28', border: '1px solid #2F9E8E44', borderRadius: 6, color: '#2F9E8E', padding: '5px 14px', cursor: 'pointer', fontSize: 11, fontWeight: 700 } }, "\u2B07 Scarica rapporto PDF")));
}))),
...
React.createElement("button", { onClick: () => generateFuncPDF(r, asset, customer, company), style: { marginTop: 10, background: '#1E1E28', border: '1px solid #2F9E8E44', borderRadius: 6, color: '#2F9E8E', padding: '5px 14px', cursor: 'pointer', fontSize: 11, fontWeight: 700 } }, "\u2B07 Scarica rapporto PDF")));
}))),
...
" sezioni")),
React.createElement("div", { style: { display: "flex", gap: 6, flexShrink: 0 } },
React.createElement("button", { onClick: () => onEdit(t), style: { background: "#1a1a22", border: "1px solid var(--border)", borderRadius: 6, color: "#6FC2B5", padding: "6px 11px", cursor: "pointer", fontSize: 12, fontWeight: 700 } }, "Modifica"),
...
const MINI_BTN = { background: "#1a1a22", border: "1px solid var(--border)", borderRadius: 6, color: "var(--text-2)", padding: "5px 10px", cursor: "pointer", fontSize: 11.5, fontWeight: 700 };
...
React.createElement("text", { x: "54", y: "40", fontFamily: "-apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: "8.5", fontWeight: "600", fill: "var(--text-4)", letterSpacing: "2" }, "MEDICAL \u00B7 CMMS")),
...
React.createElement("div", { style: { background: "#18181F", border: "1px solid var(--border)", borderRadius: 14, width: "min(640px,97vw)", maxHeight: "90vh", display: "flex", flexDirection: "column", overflow: "hidden" } },
