...
return React.createElement("div", { style: { minHeight: "100vh", background: "#0D0D12", color: "#e2e8f0", padding: 20, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 14, textAlign: "center", fontFamily: "system-ui, sans-serif" } },
React.createElement("div", { style: { fontSize: 17, fontWeight: 800, color: "#f87171" } }, "Si \u00e8 verificato un errore"),
React.createElement("div", { style: { fontSize: 12, color: "#94a3b8" } }, "Copia questo messaggio e mandalo allo sviluppatore:"),
...
stack ? React.createElement("pre", { style: { fontSize: 10, color: "#64748b", maxWidth: 540, overflow: "auto", textAlign: "left", whiteSpace: "pre-wrap", background: "#0a0a0f", border: "1px solid #1e2a3a", borderRadius: 6, padding: 10 } }, stack) : null,
React.createElement("button", { onClick: () => this.setState({ err: null }), style: { background: "#14B8A6", color: "#06251f", border: "none", borderRadius: 8, padding: "10px 20px", fontWeight: 800, cursor: "pointer" } }, "Chiudi e riprova"),
React.createElement("button", { onClick: () => window.location.reload(), style: { background: "transparent", color: "#94a3b8", border: "1px solid #2a3040", borderRadius: 8, padding: "8px 18px", cursor: "pointer" } }, "Ricarica app"));
}
...
const FORM_BTN_PRIMARY = { background: "#14B8A6", color: "#06251f", border: "none", borderRadius: 9, padding: "11px 22px", cursor: "pointer", fontWeight: 800, fontSize: 14, boxShadow: "none" };
...
label: "Incubatrice neonatale", icon: "›", norm: "IEC 60601-2-19:2020",
sections: [
{ id: "ispezione", title: "Ispezione visiva e meccanica", items: [
...
"dae": {
label: "DAE — Defibrillatore Automatico Esterno", icon: "DAE", norm: "IEC 60601-2-4:2010+AMD1:2018 / D.Lgs. 53/2021",
sections: [
{
...
label: "Aspiratore chirurgico / da secreti", icon: "ASP", norm: "ISO 10079-1:2022",
sections: [
{
id: "ispezione", title: "Ispezione visiva e meccanica",
items: [
...
"elettrobisturi": {
label: "Elettrobisturi / Unità HF chirurgica", icon: "ESU", norm: "IEC 60601-2-2:2017+A1:2023",
sections: [
{
...
"ecografo": {
label: "Ecografo", icon: "ECO", norm: "IEC 60601-2-37:2024",
sections: [
{
id: "ispezione", title: "Ispezione visiva",
items: [
...
"letto_elettrico": {
label: "Letto elettrico / barella motorizzata", icon: "LET", norm: "IEC 60601-2-52:2009+A1:2015",
sections: [
{
id: "ispezione", title: "Ispezione visiva e meccanica",
items: [
...
{
icon: "›", title: "Ricognizione RFID", color: "#2DD4BF",
steps: [
...
const vars = {
primary: { background: "#14B8A6", color: "#fff", boxShadow: "none" },
...
React.createElement("div", { style: { background: "#0D0D12", border: "1px solid #1e2a3a", borderRadius: 8, padding: "10px 14px" } },
React.createElement("div", { style: { fontSize: 10, color: "#64748b", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.04em", marginBottom: 7 } }, "Tracking RFID"),
asset.epc
? React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } },
React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline" } },
React.createElement("span", { style: { fontSize: 11, color: "#64748b" } }, "EPC"),
React.createElement("span", { style: { fontSize: 11, color: "#e2e8f0", fontFamily: "monospace" } }, asset.epc)),
asset.lastLocation
? React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline" } },
React.createElement("span", { style: { fontSize: 11, color: "#64748b" } }, "Ultima posizione"),
React.createElement("span", { style: { fontSize: 12.5, color: "#2DD4BF", fontWeight: 700 } }, asset.lastLocation + (asset.lastLocationDate ? (" \u00B7 " + fmtDateTimeIt(asset.lastLocationDate)) : "")))
: React.createElement("div", { style: { fontSize: 11, color: "#64748b", fontStyle: "italic" } }, "Tag associato, mai scansionato"))
: React.createElement("div", { style: { fontSize: 11, color: "#64748b", fontStyle: "italic" } }, "Nessun tag RFID associato \u2014 aggiungilo in modifica apparecchio")),
...
React.createElement("div", { style: { fontSize: 11.5, color: "#94a3b8", lineHeight: 1.55, marginBottom: 10 } }, "Importa la scansione del lettore RFID (file JSON). Aggiorna l'ultima posizione degli apparecchi tramite EPC e segnala quelli con manutenzione scaduta o in scadenza."),
...
rep ? React.createElement("div", { style: { marginTop: 12, background: "#0D0D12", border: "1px solid #1e2a3a", borderRadius: 8, padding: "12px 14px", fontSize: 12 } },
React.createElement("div", { style: { color: "#2DD4BF", fontWeight: 700, marginBottom: 8 } }, "Risultato scansione"),
React.createElement("div", { style: { color: "#e2e8f0", marginBottom: 4 } }, "Apparecchi aggiornati: " + rep.updated + " su " + rep.total + " letture"),
...
React.createElement("span", { style: { color: "#e2e8f0" } }, c.name + (c.location ? (" \u00B7 " + c.location) : "")),
...
Object.keys(rep.byLoc).length > 0 ? React.createElement("div", { style: { marginTop: 10, fontSize: 11, color: "#94a3b8" } },
React.createElement("div", { style: { color: "#64748b", fontWeight: 700, marginBottom: 4 } }, "Per reparto:"),
...
window.location.reload(); }, style: { width: '100%', background: '#14B8A6', color: '#000', border: 'none', borderRadius: 8, padding: 13, fontSize: 14, fontWeight: 800, cursor: 'pointer', fontFamily: 'inherit' } }, "Entra in MedTrace \u2192"))));
}
return (React.createElement("div", { style: { minHeight: '100vh', background: '#0D0D12', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 } },
...
React.createElement("button", { onClick: handle, disabled: loading, style: { width: '100%', background: '#14B8A6', color: '#000', border: 'none', borderRadius: 8, padding: 13, fontSize: 14, fontWeight: 800, cursor: loading ? 'wait' : 'pointer', opacity: loading ? .7 : 1, fontFamily: 'inherit' } }, loading ? 'Caricamento…' : mode === 'login' ? 'Accedi' : mode === 'create' ? 'Crea organizzazione' : 'Crea account'),
...
React.createElement("div", { style: { background: '#14B8A6', color: '#000', borderRadius: '50%', width: 28, height: 28, display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 900, fontSize: 13, flexShrink: 0 } }, i + 1),
React.createElement("div", { style: { flex: 1, minWidth: 0 } },
...
(form.steps || []).length,
")"),
React.createElement("button", { type: "button", onClick: addStep, style: { background: '#14B8A6', color: '#000', border: 'none', borderRadius: 6, padding: '5px 14px', cursor: 'pointer', fontSize: 11, fontWeight: 800 } }, "+ Aggiungi passo")),
...
React.createElement("button", { onClick: applyBulk, style: { background: '#14B8A6', color: '#000', border: 'none', borderRadius: 6, padding: '6px 14px', cursor: 'pointer', fontSize: 11, fontWeight: 800 } }, "Applica")))),
...
React.createElement("button", { onClick: onExit, style: { background: '#14B8A6', color: '#000', border: 'none', borderRadius: 8, padding: '10px 22px', fontWeight: 800, fontSize: 13, cursor: 'pointer' } }, "\u2190 Torna all'app"))));
}
return (React.createElement("div", { style: { minHeight: '100vh', background: '#0D0D12', fontFamily: "'Segoe UI',system-ui,sans-serif" } },
React.createElement("div", { style: { background: '#14B8A6', color: '#000', padding: '7px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: 11, fontWeight: 700, flexWrap: 'wrap', gap: 6 } },
...
React.createElement("div", { style: { position: "absolute", top: 0, left: 0, right: 0, height: "1px", background: "#1e2a3a" } }),
...
React.createElement("div", { style: { marginBottom: 12 } },
React.createElement("div", { style: { fontSize: 17, fontWeight: 800, color: "#e2e8f0" } }, "Ricognizione reparto"),
React.createElement("div", { style: { fontSize: 11.5, color: "#64748b", marginTop: 2 } }, "Scansiona gli apparecchi di un reparto: aggiorna la posizione e gestisci le scadenze sul posto.")),
React.createElement("div", { style: { background: "#0D0D12", border: "1px solid #1e2a3a", borderRadius: 10, padding: 12, marginBottom: 10 } },
React.createElement("div", { style: { fontSize: 11, color: "#94a3b8", fontWeight: 700, marginBottom: 6 } }, "REPARTO"),
React.createElement("input", { value: reconWard, onChange: e => setReconWard(e.target.value), list: "recon-wards", placeholder: "es. Cardiologia", style: { width: "100%", boxSizing: "border-box", background: "#141418", border: "1px solid #2a3040", borderRadius: 8, color: "#e2e8f0", padding: "10px 12px", fontSize: 14 } }),
React.createElement("datalist", { id: "recon-wards" }, (reconWards || []).map(w => React.createElement("option", { key: w, value: w }))),
React.createElement("div", { style: { fontSize: 10, color: "#475569", marginTop: 6 } }, "Pi\u00f9 avanti: un tag-reparto imposter\u00e0 il reparto in automatico alla scansione.")),
React.createElement("div", { style: { background: "#0D0D12", border: "1px solid #1e2a3a", borderRadius: 10, padding: 12, marginBottom: 10 } },
React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 } },
React.createElement("div", { style: { fontSize: 11, color: "#94a3b8", fontWeight: 700 } }, "EPC SCANSIONATI"),
React.createElement("button", { onClick: reconSimulate, style: { background: "transparent", border: "1px solid #2a3040", borderRadius: 6, color: "#2DD4BF", padding: "3px 8px", fontSize: 10.5, cursor: "pointer", fontWeight: 700 } }, "Simula scansione")),
React.createElement("textarea", { value: reconInput, onChange: e => setReconInput(e.target.value), placeholder: "Incolla gli EPC (uno per riga o separati). Senza lettore usa Simula scansione.", rows: 4, style: { width: "100%", boxSizing: "border-box", background: "#141418", border: "1px solid #2a3040", borderRadius: 8, color: "#e2e8f0", padding: "10px 12px", fontSize: 13, fontFamily: "monospace", resize: "vertical" } }),
...
reconResult && React.createElement("button", { onClick: () => { setReconResult(null); setReconInput(""); }, style: { background: "transparent", border: "1px solid #2a3040", borderRadius: 8, color: "#94a3b8", padding: "10px 14px", fontSize: 13, cursor: "pointer" } }, "Pulisci"))),
...
React.createElement("span", { style: { fontSize: 12, color: "#64748b" } }, "su " + reconResult.scanned + " scansionati"),
...
React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, reconResult.found.map(f => React.createElement("div", { key: f.asset.id, onClick: () => setModal({ type: "assetDetail", data: f.asset }), style: { display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", background: "#141418", border: "1px solid " + (f.status === "scaduta" ? "#ef444455" : f.status === "scadenza" ? "#f59e0b44" : "#1e2a3a"), borderRadius: 8, cursor: "pointer", touchAction: "manipulation", WebkitTapHighlightColor: "transparent" } },
React.createElement("div", { style: { flex: 1, minWidth: 0 } },
React.createElement("div", { style: { fontSize: 13.5, fontWeight: 700, color: "#e2e8f0", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, f.asset.name || f.asset.assetCode || f.asset.id),
React.createElement("div", { style: { fontSize: 11, color: "#64748b", marginTop: 1, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, (f.asset.brand || "") + (f.asset.model ? (" " + f.asset.model) : "") + (f.asset.lastLocation ? (" \u00b7 " + f.asset.lastLocation) : ""))),
...
reconResult.unknown.length > 0 && React.createElement("div", { style: { marginTop: 10, padding: "10px 12px", background: "#0D0D12", border: "1px dashed #f59e0b44", borderRadius: 8 } },
...
React.createElement("div", { style: { fontSize: 11, color: "#94a3b8", fontFamily: "monospace", wordBreak: "break-all" } }, reconResult.unknown.join("  ")),
React.createElement("div", { style: { fontSize: 10, color: "#475569", marginTop: 4 } }, "Tag non associati a nessun apparecchio. Associali dalla scheda (campo EPC).")))),
reconByWard.length > 0 && (React.createElement("div", { style: { background: "#0D0D12", border: "1px solid #1e2a3a", borderRadius: 10, padding: 12 } },
React.createElement("div", { style: { fontSize: 11, color: "#94a3b8", fontWeight: 700, marginBottom: 8 } }, "REPARTI SCANSIONATI"),
React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, reconByWard.map(r => React.createElement("div", { key: r.ward, style: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 10px", background: "#141418", borderRadius: 6 } },
React.createElement("div", null, React.createElement("span", { style: { fontSize: 13, color: "#e2e8f0", fontWeight: 600 } }, r.ward), r.last ? React.createElement("span", { style: { fontSize: 10.5, color: "#64748b", marginLeft: 8 } }, fmtDateTimeIt(r.last)) : null),
React.createElement("span", { style: { fontSize: 12, color: "#2DD4BF", fontWeight: 700 } }, r.count)))),
React.createElement("div", { style: { fontSize: 10, color: "#475569", marginTop: 8 } }, "Calcolato dall'ultima posizione di ogni apparecchio. Nessun dato aggiuntivo salvato."))))),
...
const confirmBg = isPositive ? '#14B8A6' : '#dc2626';
...
React.createElement("button", { onClick: () => answer(true), style: { background: '#14B8A6',
...
React.createElement("button", { onClick: () => window.location.reload(), style: { background: '#14B8A6', color: '#06251f', border: 'none', borderRadius: 9, padding: '11px 22px', fontWeight: 800, fontSize: 14, cursor: 'pointer' } }, "Riprova"))));
if (!currentUser)
